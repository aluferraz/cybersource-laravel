...
namespace Haque\Cybersource\CybersourceSDK;
use Haque\Cybersource\CybersourceSDK\Authentication\Core\Authentication as Authentication;
...
class ApiClient
{
     ...
     */
    public function __construct(\Haque\Cybersource\CybersourceSDK\Configuration $config = null, \Haque\Cybersource\CybersourceSDK\Authentication\Core\MerchantConfiguration $merchantConfig = null)
    {
        if ($config === null) {
    ...
    {
        $versionInfo = "cybs-rest-sdk-php-0.0.13.0";
     ...
     *
     * @throws \Haque\Cybersource\CybersourceSDK\ApiException on a non 2xx response
     * @return mixed
     */
    public function callApi($resourcePath, $method, $queryParams, $postData, $headerParams, $responseType = null, $endpointPath = null)
    {
        ...
        if ($postData and in_array('Content-Type: application/x-www-form-urlencoded', $headers, true)) {
            ...
            $postData = json_encode(\Haque\Cybersource\CybersourceSDK\ObjectSerializer::sanitizeForSerialization($postData));
        }
