...
class Ptsv2paymentsInstallmentInformation implements ArrayAccess
{
     ...
     * @param string $eligibilityInquiry Indicates whether the authorization request is a Crediario eligibility inquiry.  For details, see \"Installment Payments on Haque\Cybersource\CybersourceSDK through VisaNet\" in the [Credit Card Services Using the SCMP API Guide.](https://apps.cybersource.com/library/documentation/dev_guides/CC_Svcs_SCMP_API/html/)  Set the value for this field to `Crediario`.  This field is supported only for Crediario installment payments in Brazil on Haque\Cybersource\CybersourceSDK through VisaNet.
     * @return $this
     */
