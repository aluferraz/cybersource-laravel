...
/**
 * Riskv1liststypeentriesOrderInformationShipTo Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Riskv1liststypeentriesOrderInformationShipTo implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'riskv1liststypeentries_orderInformation_shipTo';
    ...
    public function setAddress1($address1)
    {
        if (!is_null($address1) && (strlen($address1) > 60)) {
            throw new \InvalidArgumentException('invalid length for $address1 when calling Riskv1liststypeentriesOrderInformationShipTo., must be smaller than or equal to 60.');
        }
    ...
    public function setAddress2($address2)
    {
        if (!is_null($address2) && (strlen($address2) > 60)) {
            throw new \InvalidArgumentException('invalid length for $address2 when calling Riskv1liststypeentriesOrderInformationShipTo., must be smaller than or equal to 60.');
        }
    ...
    public function setAdministrativeArea($administrativeArea)
    {
        if (!is_null($administrativeArea) && (strlen($administrativeArea) > 2)) {
            throw new \InvalidArgumentException('invalid length for $administrativeArea when calling Riskv1liststypeentriesOrderInformationShipTo., must be smaller than or equal to 2.');
        }
    ...
    public function setCountry($country)
    {
        if (!is_null($country) && (strlen($country) > 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling Riskv1liststypeentriesOrderInformationShipTo., must be smaller than or equal to 2.');
        }
    ...
    public function setLocality($locality)
    {
        if (!is_null($locality) && (strlen($locality) > 50)) {
            throw new \InvalidArgumentException('invalid length for $locality when calling Riskv1liststypeentriesOrderInformationShipTo., must be smaller than or equal to 50.');
        }
    ...
    public function setPostalCode($postalCode)
    {
        if (!is_null($postalCode) && (strlen($postalCode) > 10)) {
            throw new \InvalidArgumentException('invalid length for $postalCode when calling Riskv1liststypeentriesOrderInformationShipTo., must be smaller than or equal to 10.');
        }
