...
/**
 * InstrumentIdentifierTokenizedCard Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class InstrumentIdentifierTokenizedCard implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'InstrumentIdentifierTokenizedCard';
    ...
    protected static $swaggerTypes = [
        ...
        'type' => 'string',
        'card' => '\Haque\Cybersource\CybersourceSDK\Model\TmsV1InstrumentIdentifiersPost200ResponseTokenizedCardCard'
    ];
    ...
    public function setExpirationMonth($expirationMonth)
    {
        if (!is_null($expirationMonth) && (strlen($expirationMonth) > 2)) {
            throw new \InvalidArgumentException('invalid length for $expirationMonth when calling InstrumentIdentifierTokenizedCard., must be smaller than or equal to 2.');
        }
        if (!is_null($expirationMonth) && (strlen($expirationMonth) < 2)) {
            throw new \InvalidArgumentException('invalid length for $expirationMonth when calling InstrumentIdentifierTokenizedCard., must be bigger than or equal to 2.');
        }
    ...
    public function setExpirationYear($expirationYear)
    {
        if (!is_null($expirationYear) && (strlen($expirationYear) > 4)) {
            throw new \InvalidArgumentException('invalid length for $expirationYear when calling InstrumentIdentifierTokenizedCard., must be smaller than or equal to 4.');
        }
        if (!is_null($expirationYear) && (strlen($expirationYear) < 4)) {
            throw new \InvalidArgumentException('invalid length for $expirationYear when calling InstrumentIdentifierTokenizedCard., must be bigger than or equal to 4.');
        }
    ...
    /**
     * Gets card
     * @return \Haque\Cybersource\CybersourceSDK\Model\TmsV1InstrumentIdentifiersPost200ResponseTokenizedCardCard
     */
    ...
    /**
     * Sets card
     * @param \Haque\Cybersource\CybersourceSDK\Model\TmsV1InstrumentIdentifiersPost200ResponseTokenizedCardCard $card
     * @return $this
     */
