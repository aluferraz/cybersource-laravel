...
class TssV2TransactionsGet200ResponsePaymentInformationBank implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'bankCode' => 'string',
        'iban' => 'string',
        'account' => '\Haque\Cybersource\CybersourceSDK\Model\TssV2TransactionsGet200ResponsePaymentInformationBankAccount',
        'mandate' => '\Haque\Cybersource\CybersourceSDK\Model\TssV2TransactionsGet200ResponsePaymentInformationBankMandate'
    ];
    ...
    /**
     * Sets swiftCode
     * @param string $swiftCode Bank’s SWIFT code. You can use this field only when scoring a direct debit transaction. Required only for crossborder transactions.  For all possible values, see the `bank_swiftcode` field description in the _Decision Manager Using the SCMP API Developer Guide_ on the [Haque\Cybersource\CybersourceSDK Business Center.](https://ebc2.cybersource.com/ebc2/) Click **Decision Manager** > **Documentation** > **Guides** > _Decision Manager Using the SCMP API Developer Guide_ (PDF link).
     * @return $this
     */
    ...
    /**
     * Sets bankCode
     * @param string $bankCode Country-specific code used to identify the customer’s bank. Required for some countries if you do not or are not allowed to provide the IBAN instead. You can use this field only when scoring a direct debit transaction.  For all possible values, see the `bank_code` field description in the _Decision Manager Using the SCMP API Developer Guide_ on the [Haque\Cybersource\CybersourceSDK Business Center.](https://ebc2.cybersource.com/ebc2/) Click **Decision Manager** > **Documentation** > **Guides** > _Decision Manager Using the SCMP API Developer Guide_ (PDF link).
     * @return $this
     */
    ...
    /**
     * Sets iban
     * @param string $iban International Bank Account Number (IBAN) for the bank account. For some countries you can provide this number instead of the traditional bank account information. You can use this field only when scoring a direct debit transaction.  For all possible values, see the `bank_iban` field description in the _Decision Manager Using the SCMP API Developer Guide_ on the [Haque\Cybersource\CybersourceSDK Business Center.](https://ebc2.cybersource.com/ebc2/) Click **Decision Manager** > **Documentation** > **Guides** > _Decision Manager Using the SCMP API Developer Guide_ (PDF link).
     * @return $this
     */
    ...
    /**
     * Gets account
     * @return \Haque\Cybersource\CybersourceSDK\Model\TssV2TransactionsGet200ResponsePaymentInformationBankAccount
     */
    ...
    /**
     * Sets account
     * @param \Haque\Cybersource\CybersourceSDK\Model\TssV2TransactionsGet200ResponsePaymentInformationBankAccount $account
     * @return $this
     */
    ...
    /**
     * Gets mandate
     * @return \Haque\Cybersource\CybersourceSDK\Model\TssV2TransactionsGet200ResponsePaymentInformationBankMandate
     */
    ...
    /**
     * Sets mandate
     * @param \Haque\Cybersource\CybersourceSDK\Model\TssV2TransactionsGet200ResponsePaymentInformationBankMandate $mandate
     * @return $this
     */
