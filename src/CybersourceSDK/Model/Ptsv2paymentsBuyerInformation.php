...
class Ptsv2paymentsBuyerInformation implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'companyTaxId' => 'string',
        'personalIdentification' => '\Haque\Cybersource\CybersourceSDK\Model\Ptsv2paymentsBuyerInformationPersonalIdentification[]',
    ...
    /**
     * Sets dateOfBirth
     * @param string $dateOfBirth Recipient’s date of birth. **Format**: `YYYYMMDD`.  This field is a `pass-through`, which means that Haque\Cybersource\CybersourceSDK ensures that the value is eight numeric characters but otherwise does not verify the value or modify it in any way before sending it to the processor. If the field is not required for the transaction, Haque\Cybersource\CybersourceSDK does not forward it to the processor.  For more details, see `recipient_date_of_birth` field description in the [Credit Card Services Using the SCMP API Guide.](https://apps.cybersource.com/library/documentation/dev_guides/CC_Svcs_SCMP_API/html/)
     * @return $this
     */
     ...
     * @return \Haque\Cybersource\CybersourceSDK\Model\Ptsv2paymentsBuyerInformationPersonalIdentification[]
     */
     ...
     * @param \Haque\Cybersource\CybersourceSDK\Model\Ptsv2paymentsBuyerInformationPersonalIdentification[] $personalIdentification
     * @return $this
     */
    ...
    /**
     * Sets hashedPassword
     * @param string $hashedPassword The merchant's password that Haque\Cybersource\CybersourceSDK hashes and stores as a hashed password.  For details about this field, see the `customer_password` field description in _Decision Manager Using the SCMP API Developer Guide_ on the [Haque\Cybersource\CybersourceSDK Business Center.](https://ebc2.cybersource.com/ebc2/) Click **Decision Manager** > **Documentation** > **Guides** > _Decision Manager Using the SCMP API Developer Guide_ (PDF link).
     * @return $this
     */
