...
/**
 * Riskv1liststypeentriesOrderInformationBillTo Class Doc Comment
 *
 * @category    Class
 * @package     Haque\Cybersource\CybersourceSDK
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Riskv1liststypeentriesOrderInformationBillTo implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'riskv1liststypeentries_orderInformation_billTo';
    ...
    public function setAddress1($address1)
    {
        if (!is_null($address1) && (strlen($address1) > 60)) {
            throw new \InvalidArgumentException('invalid length for $address1 when calling Riskv1liststypeentriesOrderInformationBillTo., must be smaller than or equal to 60.');
        }
    ...
    public function setAddress2($address2)
    {
        if (!is_null($address2) && (strlen($address2) > 60)) {
            throw new \InvalidArgumentException('invalid length for $address2 when calling Riskv1liststypeentriesOrderInformationBillTo., must be smaller than or equal to 60.');
        }
    ...
    public function setAdministrativeArea($administrativeArea)
    {
        if (!is_null($administrativeArea) && (strlen($administrativeArea) > 20)) {
            throw new \InvalidArgumentException('invalid length for $administrativeArea when calling Riskv1liststypeentriesOrderInformationBillTo., must be smaller than or equal to 20.');
        }
    ...
    public function setCountry($country)
    {
        if (!is_null($country) && (strlen($country) > 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling Riskv1liststypeentriesOrderInformationBillTo., must be smaller than or equal to 2.');
        }
    ...
    public function setLocality($locality)
    {
        if (!is_null($locality) && (strlen($locality) > 50)) {
            throw new \InvalidArgumentException('invalid length for $locality when calling Riskv1liststypeentriesOrderInformationBillTo., must be smaller than or equal to 50.');
        }
    ...
    public function setPostalCode($postalCode)
    {
        if (!is_null($postalCode) && (strlen($postalCode) > 10)) {
            throw new \InvalidArgumentException('invalid length for $postalCode when calling Riskv1liststypeentriesOrderInformationBillTo., must be smaller than or equal to 10.');
        }
    ...
    public function setFirstName($firstName)
    {
        if (!is_null($firstName) && (strlen($firstName) > 60)) {
            throw new \InvalidArgumentException('invalid length for $firstName when calling Riskv1liststypeentriesOrderInformationBillTo., must be smaller than or equal to 60.');
        }
    ...
    public function setLastName($lastName)
    {
        if (!is_null($lastName) && (strlen($lastName) > 60)) {
            throw new \InvalidArgumentException('invalid length for $lastName when calling Riskv1liststypeentriesOrderInformationBillTo., must be smaller than or equal to 60.');
        }
    ...
    /**
     * Sets phoneNumber
     * @param string $phoneNumber Customer’s phone number.  #### For Payouts: This field may be sent only for FDC Compass.  Haque\Cybersource\CybersourceSDK recommends that you include the country code when the order is from outside the U.S.  For processor-specific information, see the customer_phone field in [Credit Card Services Using the SCMP API.](http://apps.cybersource.com/library/documentation/dev_guides/CC_Svcs_SCMP_API/html)  #### Haque\Cybersource\CybersourceSDK through VisaNet Credit card networks cannot process transactions that contain non-ASCII characters. Haque\Cybersource\CybersourceSDK through VisaNet accepts and stores non-ASCII characters correctly and displays them correctly in reports. However, the limitations of the credit card networks prevent Haque\Cybersource\CybersourceSDK through VisaNet from transmitting non-ASCII characters to the credit card networks. Therefore, Haque\Cybersource\CybersourceSDK through VisaNet replaces non-ASCII characters with meaningless ASCII characters for transmission to the credit card networks.
     * @return $this
     */
    public function setPhoneNumber($phoneNumber)
    {
        if (!is_null($phoneNumber) && (strlen($phoneNumber) > 15)) {
            throw new \InvalidArgumentException('invalid length for $phoneNumber when calling Riskv1liststypeentriesOrderInformationBillTo., must be smaller than or equal to 15.');
        }
    ...
    public function setEmail($email)
    {
        if (!is_null($email) && (strlen($email) > 255)) {
            throw new \InvalidArgumentException('invalid length for $email when calling Riskv1liststypeentriesOrderInformationBillTo., must be smaller than or equal to 255.');
        }
    ...
    public function setEmailDomain($emailDomain)
    {
        if (!is_null($emailDomain) && (strlen($emailDomain) > 100)) {
            throw new \InvalidArgumentException('invalid length for $emailDomain when calling Riskv1liststypeentriesOrderInformationBillTo., must be smaller than or equal to 100.');
        }
