...
class Ptsv2paymentsPointOfSaleInformation implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'emv' => '\Haque\Cybersource\CybersourceSDK\Model\Ptsv2paymentsPointOfSaleInformationEmv',
        'amexCapnData' => 'string',
        'trackData' => 'string',
     ...
     * @param string $terminalSerialNumber Terminal serial number assigned by the hardware manufacturer. This value is provided by the client software that is installed on the POS terminal.  Haque\Cybersource\CybersourceSDK does not forward this value to the processor. Instead, the value is forwarded to the Haque\Cybersource\CybersourceSDK reporting functionality.  This field is supported only on American Express Direct, FDC Nashville Global, and SIX.  For details, see the `terminal_serial_number` field description in [Card-Present Processing Using the SCMP API.](https://apps.cybersource.com/library/documentation/dev_guides/Retail_SCMP_API/html/)
     * @return $this
     */
    ...
    /**
     * Gets emv
     * @return \Haque\Cybersource\CybersourceSDK\Model\Ptsv2paymentsPointOfSaleInformationEmv
     */
    ...
    /**
     * Sets emv
     * @param \Haque\Cybersource\CybersourceSDK\Model\Ptsv2paymentsPointOfSaleInformationEmv $emv
     * @return $this
     */
     ...
     * @param string $storeAndForwardIndicator When connectivity is unavailable, the client software that is installed on the POS terminal can store a transaction in its memory and send it for authorization when connectivity is restored. This value is provided by the client software that is installed on the POS terminal.  Haque\Cybersource\CybersourceSDK does not forward this value to the processor. Instead, the value is forwarded to the Haque\Cybersource\CybersourceSDK reporting functionality.  Possible values: - Y: Transaction was stored and then forwarded. - N (default): Transaction was not stored and then forwarded.  This field is supported only on American Express Direct, FDC Nashville Global, and SIX.
     * @return $this
     */
    ...
    /**
     * Sets deviceId
     * @param string $deviceId Value created by the client software that uniquely identifies the POS device. This value is provided by the client software that is installed on the POS terminal.  Haque\Cybersource\CybersourceSDK does not forward this value to the processor. Instead, the value is forwarded to the Haque\Cybersource\CybersourceSDK reporting functionality.  This field is supported only on American Express Direct, FDC Nashville Global, and SIX.
     * @return $this
     */
     ...
     * @param string $partnerSdkVersion Version of the software installed on the POS terminal. This value is provided by the client software that is installed on the POS terminal.  Haque\Cybersource\CybersourceSDK does not forward this value to the processor. Instead, the value is forwarded to the Haque\Cybersource\CybersourceSDK reporting functionality.  This field is supported only on American Express Direct, FDC Nashville Global, and SIX.
     * @return $this
     */
