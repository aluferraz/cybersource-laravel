...
class TssV2TransactionsGet200ResponsePaymentInformationBankAccount implements ArrayAccess
{
    ...
    /**
     * Sets checkNumber
     * @param string $checkNumber Check number.  Chase Paymentech Solutions - Optional. Haque\Cybersource\CybersourceSDK ACH Service - Not used. RBS WorldPay Atlanta - Optional on debits. Required on credits. TeleCheck - Strongly recommended on debit requests. Optional on credits.
     * @return $this
     */
