...
/**
 * InstrumentIdentifierBankAccount Class Doc Comment
 *
 * @category    Class
 * @package     Haque\Cybersource\CybersourceSDK
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class InstrumentIdentifierBankAccount implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'InstrumentIdentifierBankAccount';
    ...
    public function setNumber($number)
    {
        if (!is_null($number) && (strlen($number) > 19)) {
            throw new \InvalidArgumentException('invalid length for $number when calling InstrumentIdentifierBankAccount., must be smaller than or equal to 19.');
        }
        if (!is_null($number) && (strlen($number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $number when calling InstrumentIdentifierBankAccount., must be bigger than or equal to 1.');
        }
    ...
    public function setRoutingNumber($routingNumber)
    {
        if (!is_null($routingNumber) && (strlen($routingNumber) > 9)) {
            throw new \InvalidArgumentException('invalid length for $routingNumber when calling InstrumentIdentifierBankAccount., must be smaller than or equal to 9.');
        }
        if (!is_null($routingNumber) && (strlen($routingNumber) < 1)) {
            throw new \InvalidArgumentException('invalid length for $routingNumber when calling InstrumentIdentifierBankAccount., must be bigger than or equal to 1.');
        }
