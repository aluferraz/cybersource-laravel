...
class TssV2TransactionsPost201ResponseEmbeddedPointOfSaleInformation implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'deviceId' => 'string',
        'partner' => '\Haque\Cybersource\CybersourceSDK\Model\TssV2TransactionsPost201ResponseEmbeddedPointOfSaleInformationPartner'
    ];
    ...
    /**
     * Sets deviceId
     * @param string $deviceId Value created by the client software that uniquely identifies the POS device. Haque\Cybersource\CybersourceSDK does not forward this value to the processor. Instead, the value is forwarded to the Haque\Cybersource\CybersourceSDK reporting functionality.  This field is supported only for specific Haque\Cybersource\CybersourceSDK integrations. For details, see the `pos_device_id` field description in the [Card-Present Processing Using the SCMP API Guide.](https://apps.cybersource.com/library/documentation/dev_guides/Retail_SCMP_API/html/)
     * @return $this
     */
    ...
    /**
     * Gets partner
     * @return \Haque\Cybersource\CybersourceSDK\Model\TssV2TransactionsPost201ResponseEmbeddedPointOfSaleInformationPartner
     */
    ...
    /**
     * Sets partner
     * @param \Haque\Cybersource\CybersourceSDK\Model\TssV2TransactionsPost201ResponseEmbeddedPointOfSaleInformationPartner $partner
     * @return $this
     */
