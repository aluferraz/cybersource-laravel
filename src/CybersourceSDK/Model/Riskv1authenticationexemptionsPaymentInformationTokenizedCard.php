...
/**
 * Riskv1authenticationexemptionsPaymentInformationTokenizedCard Class Doc Comment
 *
 * @category    Class
 * @package     Haque\Cybersource\CybersourceSDK
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Riskv1authenticationexemptionsPaymentInformationTokenizedCard implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'riskv1authenticationexemptions_paymentInformation_tokenizedCard';
    ...
    public function setExpirationMonth($expirationMonth)
    {
        if ((strlen($expirationMonth) > 2)) {
            throw new \InvalidArgumentException('invalid length for $expirationMonth when calling Riskv1authenticationexemptionsPaymentInformationTokenizedCard., must be smaller than or equal to 2.');
        }
    ...
    public function setExpirationYear($expirationYear)
    {
        if ((strlen($expirationYear) > 4)) {
            throw new \InvalidArgumentException('invalid length for $expirationYear when calling Riskv1authenticationexemptionsPaymentInformationTokenizedCard., must be smaller than or equal to 4.');
        }
    ...
    {
        if ((strlen($number) > 20)) {
            throw new \InvalidArgumentException('invalid length for $number when calling Riskv1authenticationexemptionsPaymentInformationTokenizedCard., must be smaller than or equal to 20.');
        }
