...
/**
 * RiskV1AuthenticationExemptionsPost201Response Class Doc Comment
 *
 * @category    Class
 * @package     Haque\Cybersource\CybersourceSDK
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class RiskV1AuthenticationExemptionsPost201Response implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'riskV1AuthenticationExemptionsPost201Response';
    ...
    protected static $swaggerTypes = [
        ...
        'status' => 'string',
        'riskInformation' => '\Haque\Cybersource\CybersourceSDK\Model\RiskV1AuthenticationExemptionsPost201ResponseRiskInformation',
        'consumerAuthenticationInformation' => '\Haque\Cybersource\CybersourceSDK\Model\RiskV1AuthenticationExemptionsPost201ResponseConsumerAuthenticationInformation',
    ...
    public function setId($id)
    {
        if (!is_null($id) && (strlen($id) > 26)) {
            throw new \InvalidArgumentException('invalid length for $id when calling RiskV1AuthenticationExemptionsPost201Response., must be smaller than or equal to 26.');
        }
    ...
    /**
     * Sets status
     * @param string $status The status for authentication-exemptions 201. Value is: - AUTHENTICATION_EXEMPTIONS_SUCCESSFUL
     * @return $this
     */
     ...
     * @return \Haque\Cybersource\CybersourceSDK\Model\RiskV1AuthenticationExemptionsPost201ResponseRiskInformation
     */
     ...
     * @param \Haque\Cybersource\CybersourceSDK\Model\RiskV1AuthenticationExemptionsPost201ResponseRiskInformation $riskInformation
     * @return $this
     */
     ...
     * @return \Haque\Cybersource\CybersourceSDK\Model\RiskV1AuthenticationExemptionsPost201ResponseConsumerAuthenticationInformation
     */
     ...
     * @param \Haque\Cybersource\CybersourceSDK\Model\RiskV1AuthenticationExemptionsPost201ResponseConsumerAuthenticationInformation $consumerAuthenticationInformation
     * @return $this
     */
