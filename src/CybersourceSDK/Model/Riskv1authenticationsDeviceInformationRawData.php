...
/**
 * Riskv1authenticationsDeviceInformationRawData Class Doc Comment
 *
 * @category    Class
 * @package     Haque\Cybersource\CybersourceSDK
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Riskv1authenticationsDeviceInformationRawData implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'riskv1authentications_deviceInformation_rawData';
    ...
    public function setProvider($provider)
    {
        if (!is_null($provider) && (strlen($provider) > 32)) {
            throw new \InvalidArgumentException('invalid length for $provider when calling Riskv1authenticationsDeviceInformationRawData., must be smaller than or equal to 32.');
        }
