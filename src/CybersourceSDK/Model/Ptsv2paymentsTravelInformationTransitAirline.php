...
class Ptsv2paymentsTravelInformationTransitAirline implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'carrierName' => 'string',
        'ticketIssuer' => '\Haque\Cybersource\CybersourceSDK\Model\Ptsv2paymentsTravelInformationTransitAirlineTicketIssuer',
        'ticketNumber' => 'string',
        'checkDigit' => 'string',
        ...
        'legs' => '\Haque\Cybersource\CybersourceSDK\Model\Ptsv2paymentsTravelInformationTransitAirlineLegs[]',
        'ancillaryInformation' => '\Haque\Cybersource\CybersourceSDK\Model\Ptsv2paymentsTravelInformationTransitAirlineAncillaryInformation'
    ];
    ...
    /**
     * Sets carrierName
     * @param string $carrierName Name of the airline. If you do not include this field, Haque\Cybersource\CybersourceSDK uses the value for your merchant name that is in the Haque\Cybersource\CybersourceSDK merchant configuration database.
     * @return $this
     */
    ...
    /**
     * Gets ticketIssuer
     * @return \Haque\Cybersource\CybersourceSDK\Model\Ptsv2paymentsTravelInformationTransitAirlineTicketIssuer
     */
    ...
    /**
     * Sets ticketIssuer
     * @param \Haque\Cybersource\CybersourceSDK\Model\Ptsv2paymentsTravelInformationTransitAirlineTicketIssuer $ticketIssuer
     * @return $this
     */
     ...
     * @param string $clearingSequence Total number of captures when requesting multiple partial captures for one authorization. Used along with airlineData_clearingCount to keep track of which capture is beingprocessed. For example, the second of five captures would be passed to Haque\Cybersource\CybersourceSDK as airlineData_clearingSequence = 2 and airlineData_clearingCount = 5.
     * @return $this
     */
     ...
     * @param string $totalClearingAmount Total clearing amount for all transactions in the clearing count set. If this field is not set and if the total amount from the original authorization is not NULL, Haque\Cybersource\CybersourceSDK sets the total clearing amount to the total amount from the original authorization.
     * @return $this
     */
     ...
     * @param int $numberOfPassengers Number of passengers for whom the ticket was issued. If you do not include this field in your request, Haque\Cybersource\CybersourceSDK uses a default value of 1.
     * @return $this
     */
    ...
    /**
     * Gets legs
     * @return \Haque\Cybersource\CybersourceSDK\Model\Ptsv2paymentsTravelInformationTransitAirlineLegs[]
     */
    ...
    /**
     * Sets legs
     * @param \Haque\Cybersource\CybersourceSDK\Model\Ptsv2paymentsTravelInformationTransitAirlineLegs[] $legs
     * @return $this
     */
     ...
     * @return \Haque\Cybersource\CybersourceSDK\Model\Ptsv2paymentsTravelInformationTransitAirlineAncillaryInformation
     */
     ...
     * @param \Haque\Cybersource\CybersourceSDK\Model\Ptsv2paymentsTravelInformationTransitAirlineAncillaryInformation $ancillaryInformation
     * @return $this
     */
