...
/**
 * TokenizeResult Class Doc Comment
 *
 * @category    Class
 * @package     Haque\Cybersource\CybersourceSDK
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class TokenizeResult implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TokenizeResult';
    ...
    /**
     * Sets token
     * @param string $token The generated token. The token replaces card data and is used as the Subscription ID in the Haque\Cybersource\CybersourceSDK Simple Order API or SCMP API.
     * @return $this
     */
