...
/**
 * RiskV1AuthenticationsPost201ResponseConsumerAuthenticationInformationIvr Class Doc Comment
 *
 * @category    Class
 * @package     Haque\Cybersource\CybersourceSDK
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class RiskV1AuthenticationsPost201ResponseConsumerAuthenticationInformationIvr implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'riskV1AuthenticationsPost201Response_consumerAuthenticationInformation_ivr';
    ...
    public function setEncryptionKey($encryptionKey)
    {
        if (!is_null($encryptionKey) && (strlen($encryptionKey) > 16)) {
            throw new \InvalidArgumentException('invalid length for $encryptionKey when calling RiskV1AuthenticationsPost201ResponseConsumerAuthenticationInformationIvr., must be smaller than or equal to 16.');
        }
    ...
    public function setEncryptionType($encryptionType)
    {
        if (!is_null($encryptionType) && (strlen($encryptionType) > 20)) {
            throw new \InvalidArgumentException('invalid length for $encryptionType when calling RiskV1AuthenticationsPost201ResponseConsumerAuthenticationInformationIvr., must be smaller than or equal to 20.');
        }
    ...
    public function setLabel($label)
    {
        if (!is_null($label) && (strlen($label) > 20)) {
            throw new \InvalidArgumentException('invalid length for $label when calling RiskV1AuthenticationsPost201ResponseConsumerAuthenticationInformationIvr., must be smaller than or equal to 20.');
        }
    ...
    public function setPrompt($prompt)
    {
        if (!is_null($prompt) && (strlen($prompt) > 80)) {
            throw new \InvalidArgumentException('invalid length for $prompt when calling RiskV1AuthenticationsPost201ResponseConsumerAuthenticationInformationIvr., must be smaller than or equal to 80.');
        }
    ...
    public function setStatusMessage($statusMessage)
    {
        if (!is_null($statusMessage) && (strlen($statusMessage) > 80)) {
            throw new \InvalidArgumentException('invalid length for $statusMessage when calling RiskV1AuthenticationsPost201ResponseConsumerAuthenticationInformationIvr., must be smaller than or equal to 80.');
        }
