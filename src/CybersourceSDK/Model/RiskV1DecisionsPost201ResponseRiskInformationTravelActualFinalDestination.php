...
/**
 * RiskV1DecisionsPost201ResponseRiskInformationTravelActualFinalDestination Class Doc Comment
 *
 * @category    Class
 * @package     Haque\Cybersource\CybersourceSDK
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class RiskV1DecisionsPost201ResponseRiskInformationTravelActualFinalDestination implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'riskV1DecisionsPost201Response_riskInformation_travel_actualFinalDestination';
    ...
    public function setCountry($country)
    {
        if (!is_null($country) && (strlen($country) > 90)) {
            throw new \InvalidArgumentException('invalid length for $country when calling RiskV1DecisionsPost201ResponseRiskInformationTravelActualFinalDestination., must be smaller than or equal to 90.');
        }
    ...
    public function setLocality($locality)
    {
        if (!is_null($locality) && (strlen($locality) > 90)) {
            throw new \InvalidArgumentException('invalid length for $locality when calling RiskV1DecisionsPost201ResponseRiskInformationTravelActualFinalDestination., must be smaller than or equal to 90.');
        }
    ...
    public function setLatitude($latitude)
    {
        if (!is_null($latitude) && (strlen($latitude) > 10)) {
            throw new \InvalidArgumentException('invalid length for $latitude when calling RiskV1DecisionsPost201ResponseRiskInformationTravelActualFinalDestination., must be smaller than or equal to 10.');
        }
    ...
    public function setLongitude($longitude)
    {
        if (!is_null($longitude) && (strlen($longitude) > 10)) {
            throw new \InvalidArgumentException('invalid length for $longitude when calling RiskV1DecisionsPost201ResponseRiskInformationTravelActualFinalDestination., must be smaller than or equal to 10.');
        }
