...
class PtsV2PaymentsPost201ResponsePaymentInformationAccountFeatures implements ArrayAccess
{
    ...
    /**
     * Sets accountStatus
     * @param string $accountStatus Possible values:   - `N`: Nonregulated  - `R`: Regulated  **Note** This field is returned only for Haque\Cybersource\CybersourceSDK through VisaNet.
     * @return $this
     */
    ...
    /**
     * Sets group
     * @param string $group Type of commercial card. This field is supported only for Haque\Cybersource\CybersourceSDK through VisaNet. Possible values:   - **B**: Business card  - **R**: Corporate card  - **S**: Purchasing card  - **0**: Noncommercial card
     * @return $this
     */
    ...
    /**
     * Sets payroll
     * @param string $payroll Indicates whether the card is a payroll card. This field is supported for Visa, Discover, Diners Club, and JCB on **Chase Paymentech Solutions**. Possible values:   - `Y`: Yes  - `N`: No  - `X`: Not applicable / Unknown  For details, see `auth_card_payroll` field description in the [Credit Card Services Using the SCMP API Guide.](https://apps.cybersource.com/library/documentation/dev_guides/CC_Svcs_SCMP_API/html/)
     * @return $this
     */
