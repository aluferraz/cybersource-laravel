...
class PtsV1TransactionBatchesIdGet200Response implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'status' => 'string',
        'links' => '\Haque\Cybersource\CybersourceSDK\Model\PtsV1TransactionBatchesIdGet200ResponseLinks'
    ];
    ...
    public function setId($id)
    {
        if (!is_null($id) && (strlen($id) > 8)) {
            throw new \InvalidArgumentException('invalid length for $id when calling PtsV1TransactionBatchesIdGet200Response., must be smaller than or equal to 8.');
        }
        if (!is_null($id) && (strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling PtsV1TransactionBatchesIdGet200Response., must be bigger than or equal to 1.');
        }
    ...
    /**
     * Gets links
     * @return \Haque\Cybersource\CybersourceSDK\Model\PtsV1TransactionBatchesIdGet200ResponseLinks
     */
    ...
    /**
     * Sets links
     * @param \Haque\Cybersource\CybersourceSDK\Model\PtsV1TransactionBatchesIdGet200ResponseLinks $links
     * @return $this
     */
