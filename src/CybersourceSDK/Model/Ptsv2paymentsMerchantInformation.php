...
class Ptsv2paymentsMerchantInformation implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'merchantDescriptor' => '\Haque\Cybersource\CybersourceSDK\Model\Ptsv2paymentsMerchantInformationMerchantDescriptor',
        ...
        'serviceFeeDescriptor' => '\Haque\Cybersource\CybersourceSDK\Model\Ptsv2paymentsMerchantInformationServiceFeeDescriptor'
    ];
     ...
     * @return \Haque\Cybersource\CybersourceSDK\Model\Ptsv2paymentsMerchantInformationMerchantDescriptor
     */
     ...
     * @param \Haque\Cybersource\CybersourceSDK\Model\Ptsv2paymentsMerchantInformationMerchantDescriptor $merchantDescriptor
     * @return $this
     */
    ...
    /**
     * Sets categoryCode
     * @param int $categoryCode The value for this field is a four-digit number that the payment card industry uses to classify merchants into market segments. A payment card company assigned one or more of these values to your business when you started accepting the payment card company’s cards. When you do not include this field in your request, Haque\Cybersource\CybersourceSDK uses the value in your Haque\Cybersource\CybersourceSDK account.  For processor-specific information, see the `merchant_category_code` field description in [Credit Card Services Using the SCMP API.](http://apps.cybersource.com/library/documentation/dev_guides/CC_Svcs_SCMP_API/html)  #### Haque\Cybersource\CybersourceSDK through VisaNet The value for this field corresponds to the following data in the TC 33 capture file5: - Record: CP01 TCR4 - Position: 150-153 - Field: Merchant Category Code
     * @return $this
     */
    ...
    /**
     * Sets taxId
     * @param string $taxId Your Cadastro Nacional da Pessoa Jurídica (CNPJ) number.  This field is supported only for BNDES transactions on Haque\Cybersource\CybersourceSDK through VisaNet.  The value for this field corresponds to the following data in the TC 33 capture file5: - Record: CP07 TCR6 - Position: 40-59 - Field: BNDES Reference Field 1  For details, see `bill_merchant_tax_id` field description in the [Credit Card Services Using the SCMP API.](https://apps.cybersource.com/library/documentation/dev_guides/CC_Svcs_SCMP_API/html/)
     * @return $this
     */
     ...
     * @return \Haque\Cybersource\CybersourceSDK\Model\Ptsv2paymentsMerchantInformationServiceFeeDescriptor
     */
     ...
     * @param \Haque\Cybersource\CybersourceSDK\Model\Ptsv2paymentsMerchantInformationServiceFeeDescriptor $serviceFeeDescriptor
     * @return $this
     */
