...
class RiskV1AuthenticationsPost201ResponseConsumerAuthenticationInformation implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'ivr' => '\Haque\Cybersource\CybersourceSDK\Model\RiskV1AuthenticationsPost201ResponseConsumerAuthenticationInformationIvr',
        'networkScore' => 'string',
        'pareq' => 'string',
        'paresStatus' => 'string',
        'proofXml' => 'string',
    ...
    /**
     * Sets cavv
     * @param string $cavv Unique identifier generated by the card-issuing bank for Visa, American Express, JCB, Diners Club, and Discover transactions after the customer is authenticated. The value is in base64. When you request the card authorization service, Haque\Cybersource\CybersourceSDK automatically converts the value, not the field name, to the format required by your payment processor.
     * @return $this
     */
    ...
    /**
     * Sets eci
     * @param string $eci Note This field applies only to non-U.S-issued cards.  For enroll, Numeric electronic commerce indicator (ECI) returned only for Visa, American Express, JCB, Diners Club, and Discover transactions when the card is not enrolled. For more information, see \"Interpreting the Reply,\" page 22.  If you are not using the Haque\Cybersource\CybersourceSDK payment services, you must send this value to your payment processor in the subsequent request for card authorization. This field contains one of these values: - `06`: The card can be enrolled. Liability shift. - `07`: The card cannot be enrolled. No liability shift.  For validate, Numeric electronic commerce indicator (ECI) returned only for Visa, American Express, JCB, Diners Club, and Discover transactions. The field is absent when authentication fails. You must send this value to your payment processor in the subsequent request for card authorization. This field contains one of these values: - `05`: Successful authentication - `06`: Authentication attempted - `07`: Failed authentication (No response from the merchant because of a problem.)
     * @return $this
     */
    ...
    /**
     * Gets ivr
     * @return \Haque\Cybersource\CybersourceSDK\Model\RiskV1AuthenticationsPost201ResponseConsumerAuthenticationInformationIvr
     */
    ...
    /**
     * Sets ivr
     * @param \Haque\Cybersource\CybersourceSDK\Model\RiskV1AuthenticationsPost201ResponseConsumerAuthenticationInformationIvr $ivr
     * @return $this
     */
    ...
    /**
     * Sets proofXml
     * @param string $proofXml Date and time of the enrollment check combined with the VEReq and VERes elements. If you ever need to show proof of enrollment checking, you may need to parse the string for the information required by the payment card company. The value can be very large. For details about possible values, see the `pa_enroll_proofxml` field description in [Haque\Cybersource\CybersourceSDK Payer Authentication Using the SCMP API.] (https://apps.cybersource.com/library/documentation/dev_guides/Payer_Authentication_SCMP_API/html/) - For cards issued in the U.S. or Canada, Visa may require this data for specific merchant category codes. - For cards not issued in the U.S. or Canada, your bank may require this data as proof of enrollment checking for any payer authentication transaction that you re-present because of a chargeback.
     * @return $this
     */
    ...
    /**
     * Sets xid
     * @param string $xid Transaction identifier generated by Haque\Cybersource\CybersourceSDK for successful enrollment or validation checks. Use this value, which is in base64, to match an outgoing PAReq with an incoming PARes. Haque\Cybersource\CybersourceSDK forwards the XID with the card authorization service to these payment processors in these cases: - Barclays - Streamline (when the **ecommerceIndicator**`=spa`)
     * @return $this
     */
