...
/**
 * PtsV2PaymentsCapturesPost201Response Class Doc Comment
 *
 * @category    Class
 * @package     Haque\Cybersource\CybersourceSDK
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class PtsV2PaymentsCapturesPost201Response implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ptsV2PaymentsCapturesPost201Response';
    ...
    protected static $swaggerTypes = [
        'links' => '\Haque\Cybersource\CybersourceSDK\Model\PtsV2PaymentsCapturesPost201ResponseLinks',
        'id' => 'string',
        ...
        'processorInformation' => '\Haque\Cybersource\CybersourceSDK\Model\PtsV2PaymentsCapturesPost201ResponseProcessorInformation',
        'orderInformation' => '\Haque\Cybersource\CybersourceSDK\Model\PtsV2PaymentsCapturesPost201ResponseOrderInformation',
        'processingInformation' => '\Haque\Cybersource\CybersourceSDK\Model\PtsV2PaymentsCapturesPost201ResponseProcessingInformation',
    ...
    /**
     * Gets links
     * @return \Haque\Cybersource\CybersourceSDK\Model\PtsV2PaymentsCapturesPost201ResponseLinks
     */
    ...
    /**
     * Sets links
     * @param \Haque\Cybersource\CybersourceSDK\Model\PtsV2PaymentsCapturesPost201ResponseLinks $links
     * @return $this
     */
    ...
    public function setId($id)
    {
        if (!is_null($id) && (strlen($id) > 26)) {
            throw new \InvalidArgumentException('invalid length for $id when calling PtsV2PaymentsCapturesPost201Response., must be smaller than or equal to 26.');
        }
    ...
    public function setReconciliationId($reconciliationId)
    {
        if (!is_null($reconciliationId) && (strlen($reconciliationId) > 60)) {
            throw new \InvalidArgumentException('invalid length for $reconciliationId when calling PtsV2PaymentsCapturesPost201Response., must be smaller than or equal to 60.');
        }
     ...
     * @return \Haque\Cybersource\CybersourceSDK\Model\PtsV2PaymentsCapturesPost201ResponseProcessorInformation
     */
     ...
     * @param \Haque\Cybersource\CybersourceSDK\Model\PtsV2PaymentsCapturesPost201ResponseProcessorInformation $processorInformation
     * @return $this
     */
     ...
     * @return \Haque\Cybersource\CybersourceSDK\Model\PtsV2PaymentsCapturesPost201ResponseOrderInformation
     */
     ...
     * @param \Haque\Cybersource\CybersourceSDK\Model\PtsV2PaymentsCapturesPost201ResponseOrderInformation $orderInformation
     * @return $this
     */
     ...
     * @return \Haque\Cybersource\CybersourceSDK\Model\PtsV2PaymentsCapturesPost201ResponseProcessingInformation
     */
     ...
     * @param \Haque\Cybersource\CybersourceSDK\Model\PtsV2PaymentsCapturesPost201ResponseProcessingInformation $processingInformation
     * @return $this
     */
