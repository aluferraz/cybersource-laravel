...
class PtsV2PaymentsPost201ResponseProcessorInformationCustomer implements ArrayAccess
{
     ...
     * @param string $personalIdResult Personal identifier result. This field is supported only for Redecard in Brazil for Haque\Cybersource\CybersourceSDK Latin American Processing. If you included `buyerInformation.personalIdentification[].ID` in the request, this value indicates whether or not `buyerInformation.personalIdentification[].ID` matched a value in a record on file. Returned only when the personal ID result is returned by the processor.  Possible values:   - **Y**: Match  - **N**: No match  - **K**: Not supported  - **U**: Unknown  - **Z**: No response returned **Note** Haque\Cybersource\CybersourceSDK Latin American Processing is the name of a specific processing connection that Haque\Cybersource\CybersourceSDK supports. In the Haque\Cybersource\CybersourceSDK API documentation, Haque\Cybersource\CybersourceSDK Latin American Processing does not refer to the general topic of processing in Latin America.The information in this field description is for the specific processing connection called Haque\Cybersource\CybersourceSDK Latin American Processing. It is not for any other Latin American processors that Haque\Cybersource\CybersourceSDK supports.
     * @return $this
     */
