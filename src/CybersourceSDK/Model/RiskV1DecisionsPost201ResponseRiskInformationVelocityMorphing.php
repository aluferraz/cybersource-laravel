...
class RiskV1DecisionsPost201ResponseRiskInformationVelocityMorphing implements ArrayAccess
{
     ...
     * @param string $informationCode Identifier that Haque\Cybersource\CybersourceSDK assigned to the velocity rule specified by the number #.  For all possible values, see the `decision_velocity_morphing_#_info_code` field description in the _Decision Manager Using the SCMP API Developer Guide_ on the [Haque\Cybersource\CybersourceSDK Business Center.](https://ebc2.cybersource.com/ebc2/) Click **Decision Manager** > **Documentation** > **Guides** > _Decision Manager Using the SCMP API Developer Guide_ (PDF link).
     * @return $this
     */
