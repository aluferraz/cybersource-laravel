...
class Riskv1authenticationsConsumerAuthenticationInformation implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'strongAuthentication' => '\Haque\Cybersource\CybersourceSDK\Model\Riskv1authenticationsConsumerAuthenticationInformationStrongAuthentication',
     ...
     * @return \Haque\Cybersource\CybersourceSDK\Model\Riskv1authenticationsConsumerAuthenticationInformationStrongAuthentication
     */
     ...
     * @param \Haque\Cybersource\CybersourceSDK\Model\Riskv1authenticationsConsumerAuthenticationInformationStrongAuthentication $strongAuthentication
     * @return $this
     */
    ...
    public function setAuthenticationType($authenticationType)
    {
        if (!is_null($authenticationType) && (strlen($authenticationType) > 2)) {
            throw new \InvalidArgumentException('invalid length for $authenticationType when calling Riskv1authenticationsConsumerAuthenticationInformation., must be smaller than or equal to 2.');
        }
    ...
    public function setAcsWindowSize($acsWindowSize)
    {
        if (!is_null($acsWindowSize) && (strlen($acsWindowSize) > 2)) {
            throw new \InvalidArgumentException('invalid length for $acsWindowSize when calling Riskv1authenticationsConsumerAuthenticationInformation., must be smaller than or equal to 2.');
        }
    ...
    public function setAuthenticationDate($authenticationDate)
    {
        if (!is_null($authenticationDate) && (strlen($authenticationDate) > 14)) {
            throw new \InvalidArgumentException('invalid length for $authenticationDate when calling Riskv1authenticationsConsumerAuthenticationInformation., must be smaller than or equal to 14.');
        }
    ...
    public function setChallengeCancelCode($challengeCancelCode)
    {
        if (!is_null($challengeCancelCode) && (strlen($challengeCancelCode) > 2)) {
            throw new \InvalidArgumentException('invalid length for $challengeCancelCode when calling Riskv1authenticationsConsumerAuthenticationInformation., must be smaller than or equal to 2.');
        }
    ...
    public function setChallengeStatus($challengeStatus)
    {
        if (!is_null($challengeStatus) && (strlen($challengeStatus) > 2)) {
            throw new \InvalidArgumentException('invalid length for $challengeStatus when calling Riskv1authenticationsConsumerAuthenticationInformation., must be smaller than or equal to 2.');
        }
    ...
    public function setDecoupledAuthenticationIndicator($decoupledAuthenticationIndicator)
    {
        if (!is_null($decoupledAuthenticationIndicator) && (strlen($decoupledAuthenticationIndicator) > 1)) {
            throw new \InvalidArgumentException('invalid length for $decoupledAuthenticationIndicator when calling Riskv1authenticationsConsumerAuthenticationInformation., must be smaller than or equal to 1.');
        }
    ...
    public function setDecoupledAuthenticationMaxTime($decoupledAuthenticationMaxTime)
    {
        if (!is_null($decoupledAuthenticationMaxTime) && (strlen($decoupledAuthenticationMaxTime) > 5)) {
            throw new \InvalidArgumentException('invalid length for $decoupledAuthenticationMaxTime when calling Riskv1authenticationsConsumerAuthenticationInformation., must be smaller than or equal to 5.');
        }
    ...
    public function setDeviceChannel($deviceChannel)
    {
        if (!is_null($deviceChannel) && (strlen($deviceChannel) > 10)) {
            throw new \InvalidArgumentException('invalid length for $deviceChannel when calling Riskv1authenticationsConsumerAuthenticationInformation., must be smaller than or equal to 10.');
        }
    ...
    public function setMerchantFraudRate($merchantFraudRate)
    {
        if (!is_null($merchantFraudRate) && (strlen($merchantFraudRate) > 2)) {
            throw new \InvalidArgumentException('invalid length for $merchantFraudRate when calling Riskv1authenticationsConsumerAuthenticationInformation., must be smaller than or equal to 2.');
        }
    ...
    public function setPriorAuthenticationData($priorAuthenticationData)
    {
        if (!is_null($priorAuthenticationData) && (strlen($priorAuthenticationData) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $priorAuthenticationData when calling Riskv1authenticationsConsumerAuthenticationInformation., must be smaller than or equal to 2048.');
        }
    ...
    public function setPriorAuthenticationMethod($priorAuthenticationMethod)
    {
        if (!is_null($priorAuthenticationMethod) && (strlen($priorAuthenticationMethod) > 2)) {
            throw new \InvalidArgumentException('invalid length for $priorAuthenticationMethod when calling Riskv1authenticationsConsumerAuthenticationInformation., must be smaller than or equal to 2.');
        }
    ...
    public function setPriorAuthenticationReferenceId($priorAuthenticationReferenceId)
    {
        if (!is_null($priorAuthenticationReferenceId) && (strlen($priorAuthenticationReferenceId) > 36)) {
            throw new \InvalidArgumentException('invalid length for $priorAuthenticationReferenceId when calling Riskv1authenticationsConsumerAuthenticationInformation., must be smaller than or equal to 36.');
        }
    ...
    public function setPriorAuthenticationTime($priorAuthenticationTime)
    {
        if (!is_null($priorAuthenticationTime) && (strlen($priorAuthenticationTime) > 12)) {
            throw new \InvalidArgumentException('invalid length for $priorAuthenticationTime when calling Riskv1authenticationsConsumerAuthenticationInformation., must be smaller than or equal to 12.');
        }
    ...
    public function setRequestorInitiatedAuthenticationIndicator($requestorInitiatedAuthenticationIndicator)
    {
        if (!is_null($requestorInitiatedAuthenticationIndicator) && (strlen($requestorInitiatedAuthenticationIndicator) > 2)) {
            throw new \InvalidArgumentException('invalid length for $requestorInitiatedAuthenticationIndicator when calling Riskv1authenticationsConsumerAuthenticationInformation., must be smaller than or equal to 2.');
        }
    ...
    public function setSdkMaxTimeout($sdkMaxTimeout)
    {
        if (!is_null($sdkMaxTimeout) && (strlen($sdkMaxTimeout) > 2)) {
            throw new \InvalidArgumentException('invalid length for $sdkMaxTimeout when calling Riskv1authenticationsConsumerAuthenticationInformation., must be smaller than or equal to 2.');
        }
    ...
    public function setSecureCorporatePaymentIndicator($secureCorporatePaymentIndicator)
    {
        if (!is_null($secureCorporatePaymentIndicator) && (strlen($secureCorporatePaymentIndicator) > 1)) {
            throw new \InvalidArgumentException('invalid length for $secureCorporatePaymentIndicator when calling Riskv1authenticationsConsumerAuthenticationInformation., must be smaller than or equal to 1.');
        }
    ...
    public function setWhiteListStatus($whiteListStatus)
    {
        if (!is_null($whiteListStatus) && (strlen($whiteListStatus) > 1)) {
            throw new \InvalidArgumentException('invalid length for $whiteListStatus when calling Riskv1authenticationsConsumerAuthenticationInformation., must be smaller than or equal to 1.');
        }
