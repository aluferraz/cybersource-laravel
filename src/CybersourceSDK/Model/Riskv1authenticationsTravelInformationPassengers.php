...
/**
 * Riskv1authenticationsTravelInformationPassengers Class Doc Comment
 *
 * @category    Class
 * @package     Haque\Cybersource\CybersourceSDK
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Riskv1authenticationsTravelInformationPassengers implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'riskv1authentications_travelInformation_passengers';
    ...
    public function setFirstName($firstName)
    {
        if (!is_null($firstName) && (strlen($firstName) > 60)) {
            throw new \InvalidArgumentException('invalid length for $firstName when calling Riskv1authenticationsTravelInformationPassengers., must be smaller than or equal to 60.');
        }
    ...
    public function setLastName($lastName)
    {
        if (!is_null($lastName) && (strlen($lastName) > 60)) {
            throw new \InvalidArgumentException('invalid length for $lastName when calling Riskv1authenticationsTravelInformationPassengers., must be smaller than or equal to 60.');
        }
