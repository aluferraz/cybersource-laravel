...
class Ptsv2paymentsAggregatorInformationSubMerchant implements ArrayAccess
{
    ...
    /**
     * Sets id
     * @param string $id The ID you assigned to your sub-merchant. Haque\Cybersource\CybersourceSDK through VisaNet: For American Express transaction, the value for this field corresponds to the following data in the TC 33 capture file: - Record: CP01 TCRB - Position: 65-84 - Field: American Express Seller ID For  Mastercard transactions, the value for this field corresponds to the following data in the TC 33 capture file: - Record: CP01 TCR6 - Position: 117-131 - Field: Mastercard Sub-Merchant ID FDC Compass: This value must consist of uppercase characters.  American Express Direct: String (20) Haque\Cybersource\CybersourceSDK through VisaNet with American Express: String (20) Haque\Cybersource\CybersourceSDK through VisaNet with Mastercard: String (15) FDC Compass: String (20) FDC Nashville Global: String (14)
     * @return $this
     */
    ...
    /**
     * Sets email
     * @param string $email Sub-merchant’s email address.  **Maximum length for processors**   - American Express Direct: 40  - Haque\Cybersource\CybersourceSDK through VisaNet: 40  - FDC Compass: 40  - FDC Nashville Global: 19  #### Haque\Cybersource\CybersourceSDK through VisaNet With American Express, the value for this field corresponds to the following data in the TC 33 capture file: - Record: CP01 TCRB - Position: 25-64 - Field: American Express Seller E-mail Address  **Note** The TC 33 Capture file contains information about the purchases and refunds that a merchant submits to Haque\Cybersource\CybersourceSDK. Haque\Cybersource\CybersourceSDK through VisaNet creates the TC 33 Capture file at the end of the day and sends it to the merchant’s acquirer, who uses this information to facilitate end-of-day clearing processing with payment card companies.
     * @return $this
     */
    ...
    /**
     * Sets phoneNumber
     * @param string $phoneNumber Sub-merchant’s telephone number.  **Maximum length for procesors**   - American Express Direct: 20  - Haque\Cybersource\CybersourceSDK through VisaNet: 20  - FDC Compass: 13  - FDC Nashville Global: 10  #### Haque\Cybersource\CybersourceSDK through VisaNet With American Express, the value for this field corresponds to the following data in the TC 33 capture file5: - Record: CP01 TCRB - Position: 5-24 - Field: American Express Seller Telephone Number  **FDC Compass**\\ This value must consist of uppercase characters. Use one of these recommended formats:\\ `NNN-NNN-NNNN`\\ `NNN-AAAAAAA`
     * @return $this
     */
