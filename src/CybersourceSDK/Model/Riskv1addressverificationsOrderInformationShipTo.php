...
/**
 * Riskv1addressverificationsOrderInformationShipTo Class Doc Comment
 *
 * @category    Class
 * @package     Haque\Cybersource\CybersourceSDK
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Riskv1addressverificationsOrderInformationShipTo implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'riskv1addressverifications_orderInformation_shipTo';
    ...
    public function setAddress1($address1)
    {
        if ((strlen($address1) > 60)) {
            throw new \InvalidArgumentException('invalid length for $address1 when calling Riskv1addressverificationsOrderInformationShipTo., must be smaller than or equal to 60.');
        }
    ...
    public function setAddress2($address2)
    {
        if (!is_null($address2) && (strlen($address2) > 60)) {
            throw new \InvalidArgumentException('invalid length for $address2 when calling Riskv1addressverificationsOrderInformationShipTo., must be smaller than or equal to 60.');
        }
    ...
    /**
     * Sets address3
     * @param string $address3 Third line of the shipping address.
     * @return $this
     */
    public function setAddress3($address3)
    {
        if (!is_null($address3) && (strlen($address3) > 60)) {
            throw new \InvalidArgumentException('invalid length for $address3 when calling Riskv1addressverificationsOrderInformationShipTo., must be smaller than or equal to 60.');
        }
    ...
    /**
     * Sets address4
     * @param string $address4 Fourth line of the shipping address.
     * @return $this
     */
    public function setAddress4($address4)
    {
        if (!is_null($address4) && (strlen($address4) > 60)) {
            throw new \InvalidArgumentException('invalid length for $address4 when calling Riskv1addressverificationsOrderInformationShipTo., must be smaller than or equal to 60.');
        }
    ...
    public function setAdministrativeArea($administrativeArea)
    {
        if (!is_null($administrativeArea) && (strlen($administrativeArea) > 2)) {
            throw new \InvalidArgumentException('invalid length for $administrativeArea when calling Riskv1addressverificationsOrderInformationShipTo., must be smaller than or equal to 2.');
        }
    ...
    {
        if ((strlen($country) > 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling Riskv1addressverificationsOrderInformationShipTo., must be smaller than or equal to 2.');
        }
    ...
    public function setLocality($locality)
    {
        if (!is_null($locality) && (strlen($locality) > 50)) {
            throw new \InvalidArgumentException('invalid length for $locality when calling Riskv1addressverificationsOrderInformationShipTo., must be smaller than or equal to 50.');
        }
    ...
    public function setPostalCode($postalCode)
    {
        if (!is_null($postalCode) && (strlen($postalCode) > 10)) {
            throw new \InvalidArgumentException('invalid length for $postalCode when calling Riskv1addressverificationsOrderInformationShipTo., must be smaller than or equal to 10.');
        }
