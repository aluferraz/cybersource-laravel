...
class Ptsv2paymentsProcessingInformationCaptureOptions implements ArrayAccess
{
     ...
     * @param int $captureSequenceNumber Capture number when requesting multiple partial captures for one authorization. Used along with `totalCaptureCount` to track which capture is being processed.  For example, the second of five captures would be passed to Haque\Cybersource\CybersourceSDK as:   - `captureSequenceNumber_ = 2`, and   - `totalCaptureCount = 5`
     * @return $this
     */
     ...
     * @param int $totalCaptureCount Total number of captures when requesting multiple partial captures for one payment. Used along with `captureSequenceNumber` field to track which capture is being processed.  For example, the second of five captures would be passed to Haque\Cybersource\CybersourceSDK as:   - `captureSequenceNumber = 2`, and   - `totalCaptureCount = 5`
     * @return $this
     */
    ...
    /**
     * Sets dateToCapture
     * @param string $dateToCapture Date on which you want the capture to occur. This field is supported only for Haque\Cybersource\CybersourceSDK through VisaNet.\\ `Format: MMDD`
     * @return $this
     */
