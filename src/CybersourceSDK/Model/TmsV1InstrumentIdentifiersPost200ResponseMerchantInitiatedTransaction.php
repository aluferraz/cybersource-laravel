...
/**
 * TmsV1InstrumentIdentifiersPost200ResponseProcessingInformationAuthorizationOptionsInitiatorMerchantInitiatedTransaction Class Doc Comment
 *
 * @category    Class
 * @package     Haque\Cybersource\CybersourceSDK
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class TmsV1InstrumentIdentifiersPost200ResponseMerchantInitiatedTransaction implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'tmsV1InstrumentIdentifiersPost200Response_processingInformation_authorizationOptions_initiator_merchantInitiatedTransaction';
    ...
    public function setPreviousTransactionId($previousTransactionId)
    {
        if (!is_null($previousTransactionId) && (strlen($previousTransactionId) > 15)) {
            throw new \InvalidArgumentException('invalid length for $previousTransactionId when calling TmsV1InstrumentIdentifiersPost200ResponseProcessingInformationAuthorizationOptionsInitiatorMerchantInitiatedTransaction., must be smaller than or equal to 15.');
        }
