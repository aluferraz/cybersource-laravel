...
/**
 * Ptsv2paymentsidTravelInformation Class Doc Comment
 *
 * @category    Class
 * @package     Haque\Cybersource\CybersourceSDK
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Ptsv2paymentsidTravelInformation implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ptsv2paymentsid_travelInformation';
    ...
    public function setDuration($duration)
    {
        if (!is_null($duration) && (strlen($duration) > 2)) {
            throw new \InvalidArgumentException('invalid length for $duration when calling Ptsv2paymentsidTravelInformation., must be smaller than or equal to 2.');
        }
