...
/**
 * TmsV1InstrumentIdentifiersPost200ResponseCard Class Doc Comment
 *
 * @category    Class
 * @package     Haque\Cybersource\CybersourceSDK
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class TmsV1InstrumentIdentifiersPost200ResponseCard implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'tmsV1InstrumentIdentifiersPost200Response_card';
    ...
    /**
     * Sets number
     * @param string $number Customer’s credit card number.
     * @return $this
     */
    public function setNumber($number)
    {
        if (!is_null($number) && (strlen($number) > 19)) {
            throw new \InvalidArgumentException('invalid length for $number when calling TmsV1InstrumentIdentifiersPost200ResponseCard., must be smaller than or equal to 19.');
        }
        if (!is_null($number) && (strlen($number) < 12)) {
            throw new \InvalidArgumentException('invalid length for $number when calling TmsV1InstrumentIdentifiersPost200ResponseCard., must be bigger than or equal to 12.');
        }
