...
/**
 * Riskv1decisionsProcessorInformationAvs Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Riskv1decisionsProcessorInformationAvs implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'riskv1decisions_processorInformation_avs';
    ...
    /**
     * Sets code
     * @param string $code Value returned for address verification from the Payments Authorization response.
     * @return $this
     */
