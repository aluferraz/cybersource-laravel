...
class Riskv1authenticationsOrderInformationLineItems implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'productName' => 'string',
        'passenger' => '\Haque\Cybersource\CybersourceSDK\Model\Riskv1decisionsOrderInformationPassenger',
     ...
     * @param int $giftCardCurrency When `orderInformation.lineItems[].productCode` is \"gift_card\", this is the currency used for the gift card purchase.  For details, see `pa_gift_card_currency` field description in [Haque\Cybersource\CybersourceSDK Payer Authentication Using the SCMP API.] (https://apps.cybersource.com/library/documentation/dev_guides/Payer_Authentication_SCMP_API/Payer_Authentication_SCMP_API.pdf)  For the possible values, see the [ISO Standard Currency Codes.](http://apps.cybersource.com/library/documentation/sbc/quickref/currencies.pdf)
     * @return $this
     */
    ...
    /**
     * Gets passenger
     * @return \Haque\Cybersource\CybersourceSDK\Model\Riskv1decisionsOrderInformationPassenger
     */
    ...
    /**
     * Sets passenger
     * @param \Haque\Cybersource\CybersourceSDK\Model\Riskv1decisionsOrderInformationPassenger $passenger
     * @return $this
     */
