...
class RiskV1UpdatePost201Response implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'clientReferenceInformaton' => '\Haque\Cybersource\CybersourceSDK\Model\PtsV2IncrementalAuthorizationPatch201ResponseClientReferenceInformation',
        'id' => 'string',
        'status' => 'string',
     ...
     * @param \Haque\Cybersource\CybersourceSDK\Model\PtsV2IncrementalAuthorizationPatch201ResponseClientReferenceInformation $clientReferenceInformaton
     * @return $this
     */
    ...
    public function setId($id)
    {
        if (!is_null($id) && (strlen($id) > 26)) {
            throw new \InvalidArgumentException('invalid length for $id when calling RiskV1UpdatePost201Response., must be smaller than or equal to 26.');
        }
