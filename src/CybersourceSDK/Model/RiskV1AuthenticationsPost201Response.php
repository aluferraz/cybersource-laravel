...
class RiskV1AuthenticationsPost201Response implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'orderInformation' => '\Haque\Cybersource\CybersourceSDK\Model\RiskV1AuthenticationsPost201ResponseOrderInformation',
        'consumerAuthenticationInformation' => '\Haque\Cybersource\CybersourceSDK\Model\RiskV1AuthenticationsPost201ResponseConsumerAuthenticationInformation',
    ...
    public function setId($id)
    {
        if (!is_null($id) && (strlen($id) > 26)) {
            throw new \InvalidArgumentException('invalid length for $id when calling RiskV1AuthenticationsPost201Response., must be smaller than or equal to 26.');
        }
     ...
     * @return \Haque\Cybersource\CybersourceSDK\Model\RiskV1AuthenticationsPost201ResponseOrderInformation
     */
     ...
     * @param \Haque\Cybersource\CybersourceSDK\Model\RiskV1AuthenticationsPost201ResponseOrderInformation $orderInformation
     * @return $this
     */
     ...
     * @return \Haque\Cybersource\CybersourceSDK\Model\RiskV1AuthenticationsPost201ResponseConsumerAuthenticationInformation
     */
     ...
     * @param \Haque\Cybersource\CybersourceSDK\Model\RiskV1AuthenticationsPost201ResponseConsumerAuthenticationInformation $consumerAuthenticationInformation
     * @return $this
     */
