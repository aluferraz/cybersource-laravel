...
class Riskv1decisionsOrderInformationPassenger implements ArrayAccess
{
    ...
    /**
     * Sets phone
     * @param string $phone Passenger's phone number. If the order is from outside the U.S., Haque\Cybersource\CybersourceSDK recommends that you include the [ISO Standard Country Codes.](http://apps.cybersource.com/library/documentation/sbc/quickref/countries_alpha_list.pdf)
     * @return $this
     */
