...
class Issuer implements ArrayAccess
{
    ...
    public function setPaymentAccountReference($paymentAccountReference)
    {
        if (!is_null($paymentAccountReference) && (strlen($paymentAccountReference) > 29)) {
            throw new \InvalidArgumentException('invalid length for $paymentAccountReference when calling Issuer., must be smaller than or equal to 29.');
        }
        if (!is_null($paymentAccountReference) && (strlen($paymentAccountReference) < 29)) {
            throw new \InvalidArgumentException('invalid length for $paymentAccountReference when calling Issuer., must be bigger than or equal to 29.');
        }
