...
/**
 * Riskv1exportcomplianceinquiriesOrderInformationBillToCompany Class Doc Comment
 *
 * @category    Class
 * @package     Haque\Cybersource\CybersourceSDK
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Riskv1exportcomplianceinquiriesOrderInformationBillToCompany implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'riskv1exportcomplianceinquiries_orderInformation_billTo_company';
    ...
    /**
     * Sets name
     * @param string $name Company name of person buying the product. Important: This field or billTo.firstName and billTo.lastName must be present. Else, your request will fail.
     * @return $this
     */
