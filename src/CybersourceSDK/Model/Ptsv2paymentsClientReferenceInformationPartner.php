...
class Ptsv2paymentsClientReferenceInformationPartner implements ArrayAccess
{
     ...
     * @param string $originalTransactionId Value that links the previous transaction to the current follow-on request. This value is assigned by the client software that is installed on the POS terminal, which makes it available to the terminal’s software and to Haque\Cybersource\CybersourceSDK. Therefore, you can use this value to reconcile transactions between Haque\Cybersource\CybersourceSDK and the terminal’s software.  Haque\Cybersource\CybersourceSDK does not forward this value to the processor. Instead, the value is forwarded to the Haque\Cybersource\CybersourceSDK reporting functionality.  This field is supported only on American Express Direct, FDC Nashville Global, and SIX.
     * @return $this
     */
    ...
    /**
     * Sets developerId
     * @param string $developerId Identifier for the developer that helped integrate a partner solution to Haque\Cybersource\CybersourceSDK.  Send this value in all requests that are sent through the partner solutions built by that developer. Haque\Cybersource\CybersourceSDK assigns the ID to the developer.  **Note** When you see a developer ID of 999 in reports, the developer ID that was submitted is incorrect.
     * @return $this
     */
    ...
    /**
     * Sets solutionId
     * @param string $solutionId Identifier for the partner that is integrated to Haque\Cybersource\CybersourceSDK.  Send this value in all requests that are sent through the partner solution. Haque\Cybersource\CybersourceSDK assigns the ID to the partner.  **Note** When you see a partner ID of 999 in reports, the partner ID that was submitted is incorrect.
     * @return $this
     */
     ...
     * @param string $thirdPartyCertificationNumber Value that identifies the application vendor and application version for a third party gateway. Haque\Cybersource\CybersourceSDK provides you with this value during testing and validation. This field is supported only on Haque\Cybersource\CybersourceSDK through VisaNet.
     * @return $this
     */
