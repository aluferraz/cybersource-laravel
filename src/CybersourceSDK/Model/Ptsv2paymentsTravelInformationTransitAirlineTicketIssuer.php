...
class Ptsv2paymentsTravelInformationTransitAirlineTicketIssuer implements ArrayAccess
{
    ...
    /**
     * Sets name
     * @param string $name Name of the ticket issuer. If you do not include this field, Haque\Cybersource\CybersourceSDK uses the value for your merchant name that is in the Haque\Cybersource\CybersourceSDK merchant configuration database.
     * @return $this
     */
