...
/**
 * Riskv1authenticationsMerchantInformation Class Doc Comment
 *
 * @category    Class
 * @package     Haque\Cybersource\CybersourceSDK
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Riskv1authenticationsMerchantInformation implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'riskv1authentications_merchantInformation';
    ...
    protected static $swaggerTypes = [
        'merchantDescriptor' => '\Haque\Cybersource\CybersourceSDK\Model\Riskv1authenticationsMerchantInformationMerchantDescriptor',
        'merchantName' => 'string'
    ];
     ...
     * @return \Haque\Cybersource\CybersourceSDK\Model\Riskv1authenticationsMerchantInformationMerchantDescriptor
     */
     ...
     * @param \Haque\Cybersource\CybersourceSDK\Model\Riskv1authenticationsMerchantInformationMerchantDescriptor $merchantDescriptor
     * @return $this
     */
    ...
    public function setMerchantName($merchantName)
    {
        if (!is_null($merchantName) && (strlen($merchantName) > 25)) {
            throw new \InvalidArgumentException('invalid length for $merchantName when calling Riskv1authenticationsMerchantInformation., must be smaller than or equal to 25.');
        }
