...
/**
 * TssV2TransactionsPost201ResponseEmbeddedMerchantInformation Class Doc Comment
 *
 * @category    Class
 * @package     Haque\Cybersource\CybersourceSDK
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class TssV2TransactionsPost201ResponseEmbeddedMerchantInformation implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'tssV2TransactionsPost201Response__embedded_merchantInformation';
    ...
    /**
     * Sets resellerId
     * @param string $resellerId An unique identification number assigned by Haque\Cybersource\CybersourceSDK to identify the submitted request. It is also appended to the endpoint of the resource.  On incremental authorizations, this value with be the same as the identification number returned in the original authorization response.
     * @return $this
     */
