...
/**
 * TssV2TransactionsPost201ResponseEmbeddedClientReferenceInformation Class Doc Comment
 *
 * @category    Class
 * @package     Haque\Cybersource\CybersourceSDK
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class TssV2TransactionsPost201ResponseEmbeddedClientReferenceInformation implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'tssV2TransactionsPost201Response__embedded_clientReferenceInformation';
     ...
     * @param string $applicationName The name of the Connection Method client (such as Virtual Terminal or SOAP Toolkit API) that the merchant uses to send a transaction request to Haque\Cybersource\CybersourceSDK.
     * @return $this
     */
     ...
     * @param string $applicationUser The entity that is responsible for running the transaction and submitting the processing request to Haque\Cybersource\CybersourceSDK. This could be a person, a system, or a connection method.
     * @return $this
     */
