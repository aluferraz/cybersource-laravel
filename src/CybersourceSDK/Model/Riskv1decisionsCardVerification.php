...
/**
 * Riskv1decisionsCardVerification Class Doc Comment
 *
 * @category    Class
 * @package     Haque\Cybersource\CybersourceSDK
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Riskv1decisionsCardVerification implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'riskv1decisions_cardVerification';
    ...
    public function setResultCode($resultCode)
    {
        if (!is_null($resultCode) && (strlen($resultCode) > 1)) {
            throw new \InvalidArgumentException('invalid length for $resultCode when calling Riskv1decisionsCardVerification., must be smaller than or equal to 1.');
        }
