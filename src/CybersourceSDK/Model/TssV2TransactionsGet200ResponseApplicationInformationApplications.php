...
class TssV2TransactionsGet200ResponseApplicationInformationApplications implements ArrayAccess
{
    ...
    /**
     * Sets name
     * @param string $name The name of the Haque\Cybersource\CybersourceSDK transaction type (such as CC settlement or CC authorization) that the merchant wants to process in a transaction request. More than one transaction type can included in a transaction request. Each transaction type separately returns their own status, reasonCode, rCode, and rFlag messages.
     * @return $this
     */
     ...
     * @param string $reconciliationId Reference number that you use to reconcile your Haque\Cybersource\CybersourceSDK reports with your processor reports.
     * @return $this
     */
