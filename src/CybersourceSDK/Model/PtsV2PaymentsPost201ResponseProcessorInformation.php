...
class PtsV2PaymentsPost201ResponseProcessorInformation implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'avs' => '\Haque\Cybersource\CybersourceSDK\Model\PtsV2PaymentsPost201ResponseProcessorInformationAvs',
        'cardVerification' => '\Haque\Cybersource\CybersourceSDK\Model\PtsV2PaymentsPost201ResponseProcessorInformationCardVerification',
        'merchantAdvice' => '\Haque\Cybersource\CybersourceSDK\Model\PtsV2PaymentsPost201ResponseProcessorInformationMerchantAdvice',
        'electronicVerificationResults' => '\Haque\Cybersource\CybersourceSDK\Model\PtsV2PaymentsPost201ResponseProcessorInformationElectronicVerificationResults',
        'achVerification' => '\Haque\Cybersource\CybersourceSDK\Model\PtsV2PaymentsPost201ResponseProcessorInformationAchVerification',
        'customer' => '\Haque\Cybersource\CybersourceSDK\Model\PtsV2PaymentsPost201ResponseProcessorInformationCustomer',
        'consumerAuthenticationResponse' => '\Haque\Cybersource\CybersourceSDK\Model\PtsV2PaymentsPost201ResponseProcessorInformationConsumerAuthenticationResponse',
        ...
        'name' => 'string',
        'routing' => '\Haque\Cybersource\CybersourceSDK\Model\PtsV2PaymentsPost201ResponseProcessorInformationRouting',
     ...
     * @param string $responseDetails This field might contain information about a decline. This field is supported only for **Haque\Cybersource\CybersourceSDK through VisaNet**.
     * @return $this
     */
     ...
     * @param string $responseCategoryCode Processor-defined response category code. The associated detail error code is in the `responseCode` field of the service you requested.  This field is supported only for:   - Japanese issuers  - Domestic transactions in Japan  - Comercio Latino—processor transaction ID required for troubleshooting  **Maximum length for processors**:   - Comercio Latino: 32  - All other processors: 3
     * @return $this
     */
    public function setResponseCategoryCode($responseCategoryCode)
    {
        if (!is_null($responseCategoryCode) && (strlen($responseCategoryCode) > 32)) {
            throw new \InvalidArgumentException('invalid length for $responseCategoryCode when calling PtsV2PaymentsPost201ResponseProcessorInformation., must be smaller than or equal to 32.');
        }
     ...
     * @param string $forwardedAcquirerCode Name of the Japanese acquirer that processed the transaction. Returned only for JCN Gateway. Please contact the Haque\Cybersource\CybersourceSDK Japan Support Group for more information.
     * @return $this
     */
    ...
    /**
     * Gets avs
     * @return \Haque\Cybersource\CybersourceSDK\Model\PtsV2PaymentsPost201ResponseProcessorInformationAvs
     */
    ...
    /**
     * Sets avs
     * @param \Haque\Cybersource\CybersourceSDK\Model\PtsV2PaymentsPost201ResponseProcessorInformationAvs $avs
     * @return $this
     */
     ...
     * @return \Haque\Cybersource\CybersourceSDK\Model\PtsV2PaymentsPost201ResponseProcessorInformationCardVerification
     */
     ...
     * @param \Haque\Cybersource\CybersourceSDK\Model\PtsV2PaymentsPost201ResponseProcessorInformationCardVerification $cardVerification
     * @return $this
     */
    ...
    /**
     * Gets merchantAdvice
     * @return \Haque\Cybersource\CybersourceSDK\Model\PtsV2PaymentsPost201ResponseProcessorInformationMerchantAdvice
     */
    ...
    /**
     * Sets merchantAdvice
     * @param \Haque\Cybersource\CybersourceSDK\Model\PtsV2PaymentsPost201ResponseProcessorInformationMerchantAdvice $merchantAdvice
     * @return $this
     */
     ...
     * @return \Haque\Cybersource\CybersourceSDK\Model\PtsV2PaymentsPost201ResponseProcessorInformationElectronicVerificationResults
     */
     ...
     * @param \Haque\Cybersource\CybersourceSDK\Model\PtsV2PaymentsPost201ResponseProcessorInformationElectronicVerificationResults $electronicVerificationResults
     * @return $this
     */
     ...
     * @return \Haque\Cybersource\CybersourceSDK\Model\PtsV2PaymentsPost201ResponseProcessorInformationAchVerification
     */
     ...
     * @param \Haque\Cybersource\CybersourceSDK\Model\PtsV2PaymentsPost201ResponseProcessorInformationAchVerification $achVerification
     * @return $this
     */
    ...
    /**
     * Gets customer
     * @return \Haque\Cybersource\CybersourceSDK\Model\PtsV2PaymentsPost201ResponseProcessorInformationCustomer
     */
    ...
    /**
     * Sets customer
     * @param \Haque\Cybersource\CybersourceSDK\Model\PtsV2PaymentsPost201ResponseProcessorInformationCustomer $customer
     * @return $this
     */
     ...
     * @return \Haque\Cybersource\CybersourceSDK\Model\PtsV2PaymentsPost201ResponseProcessorInformationConsumerAuthenticationResponse
     */
     ...
     * @param \Haque\Cybersource\CybersourceSDK\Model\PtsV2PaymentsPost201ResponseProcessorInformationConsumerAuthenticationResponse $consumerAuthenticationResponse
     * @return $this
     */
     ...
     * @param string $systemTraceAuditNumber This field is returned only for **American Express Direct** and **Haque\Cybersource\CybersourceSDK through VisaNet**.  #### American Express Direct  System trace audit number (STAN). This value identifies the transaction and is useful when investigating a chargeback dispute.  #### Haque\Cybersource\CybersourceSDK through VisaNet  System trace number that must be printed on the customer’s receipt.  For details, see `receipt_number` field description in [Credit Card Services Using the SCMP API.](https://apps.cybersource.com/library/documentation/dev_guides/CC_Svcs_SCMP_API/html/)
     * @return $this
     */
     ...
     * @param string $masterCardServiceCode Mastercard service that was used for the transaction. Mastercard provides this value to Haque\Cybersource\CybersourceSDK.  Possible value:  - 53: Mastercard card-on-file token service  #### Haque\Cybersource\CybersourceSDK through VisaNet The value for this field corresponds to the following data in the TC 33 capture file: - Record: CP01 TCR6 - Position: 133-134 - Field: Mastercard Merchant on-behalf service. **Note** This field is returned only for Haque\Cybersource\CybersourceSDK through VisaNet.
     * @return $this
     */
     ...
     * @param string $masterCardServiceReplyCode Result of the Mastercard card-on-file token service. Mastercard provides this value to Haque\Cybersource\CybersourceSDK.  Possible values:   - `C`: Service completed successfully.  - `F`: One of the following:    - Incorrect Mastercard POS entry mode. The Mastercard POS entry mode should be 81 for an authorization or      authorization reversal.    - Incorrect Mastercard POS entry mode. The Mastercard POS entry mode should be 01 for a tokenized request.    - Token requestor ID is missing or formatted incorrectly.  - `I`: One of the following:    - Invalid token requestor ID.    - Suspended or deactivated token.    - Invalid token (not in mapping table).  - `T`: Invalid combination of token requestor ID and token.  - `U`: Expired token.  - `W`: Primary account number (PAN) listed in electronic warning bulletin.  **Note** This field is returned only for **Haque\Cybersource\CybersourceSDK through VisaNet**.
     * @return $this
     */
     ...
     * @param string $masterCardAuthenticationType Type of authentication for which the transaction qualifies as determined by the Mastercard authentication service, which confirms the identity of the cardholder. Mastercard provides this value to Haque\Cybersource\CybersourceSDK.  Possible values:   - `1`: Transaction qualifies for Mastercard authentication type 1.  - `2`: Transaction qualifies for Mastercard authentication type 2.  #### Haque\Cybersource\CybersourceSDK through VisaNet The value for this field corresponds to the following data in the TC 33 capture file: - Record: CP01 TCR6 - Position: 132 - Field: Mastercard Member Defined service. **Note** This field is returned only for Haque\Cybersource\CybersourceSDK through VisaNet.
     * @return $this
     */
    ...
    /**
     * Gets routing
     * @return \Haque\Cybersource\CybersourceSDK\Model\PtsV2PaymentsPost201ResponseProcessorInformationRouting
     */
    ...
    /**
     * Sets routing
     * @param \Haque\Cybersource\CybersourceSDK\Model\PtsV2PaymentsPost201ResponseProcessorInformationRouting $routing
     * @return $this
     */
