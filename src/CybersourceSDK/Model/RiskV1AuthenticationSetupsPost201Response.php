...
class RiskV1AuthenticationSetupsPost201Response implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'status' => 'string',
        'consumerAuthenticationInformation' => '\Haque\Cybersource\CybersourceSDK\Model\RiskV1AuthenticationSetupsPost201ResponseConsumerAuthenticationInformation',
        'errorInformation' => '\Haque\Cybersource\CybersourceSDK\Model\RiskV1AuthenticationSetupsPost201ResponseErrorInformation'
    ];
    ...
    public function setId($id)
    {
        if (!is_null($id) && (strlen($id) > 26)) {
            throw new \InvalidArgumentException('invalid length for $id when calling RiskV1AuthenticationSetupsPost201Response., must be smaller than or equal to 26.');
        }
     ...
     * @return \Haque\Cybersource\CybersourceSDK\Model\RiskV1AuthenticationSetupsPost201ResponseConsumerAuthenticationInformation
     */
     ...
     * @param \Haque\Cybersource\CybersourceSDK\Model\RiskV1AuthenticationSetupsPost201ResponseConsumerAuthenticationInformation $consumerAuthenticationInformation
     * @return $this
     */
     ...
     * @return \Haque\Cybersource\CybersourceSDK\Model\RiskV1AuthenticationSetupsPost201ResponseErrorInformation
     */
     ...
     * @param \Haque\Cybersource\CybersourceSDK\Model\RiskV1AuthenticationSetupsPost201ResponseErrorInformation $errorInformation
     * @return $this
     */
