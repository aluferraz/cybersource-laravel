...
/**
 * Riskv1authenticationsRiskInformationBuyerHistoryCustomerAccount Class Doc Comment
 *
 * @category    Class
 * @package     Haque\Cybersource\CybersourceSDK
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Riskv1authenticationsRiskInformationBuyerHistoryCustomerAccount implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'riskv1authentications_riskInformation_buyerHistory_customerAccount';
    ...
    public function setLastChangeDate($lastChangeDate)
    {
        if (!is_null($lastChangeDate) && (strlen($lastChangeDate) > 10)) {
            throw new \InvalidArgumentException('invalid length for $lastChangeDate when calling Riskv1authenticationsRiskInformationBuyerHistoryCustomerAccount., must be smaller than or equal to 10.');
        }
    ...
    public function setCreateDate($createDate)
    {
        if (!is_null($createDate) && (strlen($createDate) > 10)) {
            throw new \InvalidArgumentException('invalid length for $createDate when calling Riskv1authenticationsRiskInformationBuyerHistoryCustomerAccount., must be smaller than or equal to 10.');
        }
    ...
    public function setPasswordChangeDate($passwordChangeDate)
    {
        if (!is_null($passwordChangeDate) && (strlen($passwordChangeDate) > 10)) {
            throw new \InvalidArgumentException('invalid length for $passwordChangeDate when calling Riskv1authenticationsRiskInformationBuyerHistoryCustomerAccount., must be smaller than or equal to 10.');
        }
