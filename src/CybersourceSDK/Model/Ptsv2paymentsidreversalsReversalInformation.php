...
class Ptsv2paymentsidreversalsReversalInformation implements ArrayAccess
{
    ...
    /**
     * Sets reason
     * @param string $reason Reason for the authorization reversal. Possible value:   - `34`: Suspected fraud  Haque\Cybersource\CybersourceSDK ignores this field for processors that do not support this value.  For details, see `auth_reversal_reason` field description in [Credit Card Services Using the SCMP API.](https://apps.cybersource.com/library/documentation/dev_guides/CC_Svcs_SCMP_API/html/)
     * @return $this
     */
