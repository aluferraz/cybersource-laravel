...
/**
 * Tmsv1instrumentidentifiersDetails Class Doc Comment
 *
 * @category    Class
 * @package     Haque\Cybersource\CybersourceSDK
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Tmsv1instrumentidentifiersDetails implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'tmsv1instrumentidentifiers_details';
    ...
    /**
     * Sets name
     * @param string $name The name of the field that threw the error.
     * @return $this
     */
    ...
    /**
     * Sets location
     * @param string $location The location of the field that threw the error.
     * @return $this
     */
