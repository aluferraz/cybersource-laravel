...
class Ptsv2paymentsProcessingInformation implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'authorizationOptions' => '\Haque\Cybersource\CybersourceSDK\Model\Ptsv2paymentsProcessingInformationAuthorizationOptions',
        'captureOptions' => '\Haque\Cybersource\CybersourceSDK\Model\Ptsv2paymentsProcessingInformationCaptureOptions',
        'recurringOptions' => '\Haque\Cybersource\CybersourceSDK\Model\Ptsv2paymentsProcessingInformationRecurringOptions',
        'bankTransferOptions' => '\Haque\Cybersource\CybersourceSDK\Model\Ptsv2paymentsProcessingInformationBankTransferOptions',
        'purchaseOptions' => '\Haque\Cybersource\CybersourceSDK\Model\Ptsv2paymentsProcessingInformationPurchaseOptions',
        'electronicBenefitsTransfer' => '\Haque\Cybersource\CybersourceSDK\Model\Ptsv2paymentsProcessingInformationElectronicBenefitsTransfer',
        'loanOptions' => '\Haque\Cybersource\CybersourceSDK\Model\Ptsv2paymentsProcessingInformationLoanOptions',
        'walletType' => 'string',
        'nationalNetDomesticData' => 'string',
        'japanPaymentOptions' => '\Haque\Cybersource\CybersourceSDK\Model\Ptsv2paymentsProcessingInformationJapanPaymentOptions',
    ...
    /**
     * Sets processorId
     * @param string $processorId Value that identifies the processor/acquirer to use for the transaction. This value is supported only for **Haque\Cybersource\CybersourceSDK through VisaNet**.  Contact Haque\Cybersource\CybersourceSDK Customer Support to get the value for this field.
     * @return $this
     */
     ...
     * @param string $businessApplicationId Payouts transaction type. Required for OCT transactions. This field is a pass-through, which means that Haque\Cybersource\CybersourceSDK does not verify the value or modify it in any way before sending it to the processor. **Note** When the request includes this field, this value overrides the information in your Haque\Cybersource\CybersourceSDK account.  For valid values, see the `invoiceHeader_businessApplicationID` field description in [Payouts Using the Simple Order API.](http://apps.cybersource.com/library/documentation/dev_guides/payouts_SO/Payouts_SO_API.pdf)
     * @return $this
     */
     ...
     * @param string $industryDataType Flag that indicates that the transaction includes airline data or restaurant data.  This field must be set to `airline` in order for airline data to be sent to the processor.  For example, if this field is not set to airline or is not included in the request, Haque\Cybersource\CybersourceSDK does not send airline data to the processor.  You must set this field to `restaurant` in order for restaurant data to be sent to the processor.  When this field is not set to restaurant or is not included in the request, Haque\Cybersource\CybersourceSDK does not send restaurant data to the processor.  Possible Values:  - `airline` - `restaurant` - `lodging` - `auto_rental` - `transit` - `healthcare_medical` - `healthcare_transit`
     * @return $this
     */
     ...
     * @return \Haque\Cybersource\CybersourceSDK\Model\Ptsv2paymentsProcessingInformationAuthorizationOptions
     */
     ...
     * @param \Haque\Cybersource\CybersourceSDK\Model\Ptsv2paymentsProcessingInformationAuthorizationOptions $authorizationOptions
     * @return $this
     */
    ...
    /**
     * Gets captureOptions
     * @return \Haque\Cybersource\CybersourceSDK\Model\Ptsv2paymentsProcessingInformationCaptureOptions
     */
    ...
    /**
     * Sets captureOptions
     * @param \Haque\Cybersource\CybersourceSDK\Model\Ptsv2paymentsProcessingInformationCaptureOptions $captureOptions
     * @return $this
     */
     ...
     * @return \Haque\Cybersource\CybersourceSDK\Model\Ptsv2paymentsProcessingInformationRecurringOptions
     */
     ...
     * @param \Haque\Cybersource\CybersourceSDK\Model\Ptsv2paymentsProcessingInformationRecurringOptions $recurringOptions
     * @return $this
     */
     ...
     * @return \Haque\Cybersource\CybersourceSDK\Model\Ptsv2paymentsProcessingInformationBankTransferOptions
     */
     ...
     * @param \Haque\Cybersource\CybersourceSDK\Model\Ptsv2paymentsProcessingInformationBankTransferOptions $bankTransferOptions
     * @return $this
     */
     ...
     * @return \Haque\Cybersource\CybersourceSDK\Model\Ptsv2paymentsProcessingInformationPurchaseOptions
     */
     ...
     * @param \Haque\Cybersource\CybersourceSDK\Model\Ptsv2paymentsProcessingInformationPurchaseOptions $purchaseOptions
     * @return $this
     */
     ...
     * @return \Haque\Cybersource\CybersourceSDK\Model\Ptsv2paymentsProcessingInformationElectronicBenefitsTransfer
     */
     ...
     * @param \Haque\Cybersource\CybersourceSDK\Model\Ptsv2paymentsProcessingInformationElectronicBenefitsTransfer $electronicBenefitsTransfer
     * @return $this
     */
    ...
    /**
     * Gets loanOptions
     * @return \Haque\Cybersource\CybersourceSDK\Model\Ptsv2paymentsProcessingInformationLoanOptions
     */
    ...
    /**
     * Sets loanOptions
     * @param \Haque\Cybersource\CybersourceSDK\Model\Ptsv2paymentsProcessingInformationLoanOptions $loanOptions
     * @return $this
     */
    ...
    /**
     * Sets walletType
     * @param string $walletType This field carries the wallet type in authorization requests and credit requests. Possible value are: - `101`: Masterpass remote payment. The customer created the wallet by manually interacting with a customer-controlled device such as a computer, tablet, or phone. This value is supported only for Masterpass transactions on Chase Paymentech Solutions and Haque\Cybersource\CybersourceSDK through VisaNet. - `102`: Masterpass remote near field communication (NFC) payment. The customer created the wallet by tapping a PayPass card or customer-controlled device at a contactless card reader. This value is supported only for card-present Masterpass transactions on Haque\Cybersource\CybersourceSDK through VisaNet. - `103`: Masterpass Apple Pay payment. The payment was made with a combination of Masterpass and Apple Pay. This value is supported only for Masterpass Apple Pay transactions on Haque\Cybersource\CybersourceSDK through VisaNet. - `216`: Masterpass Google Pay payment. The payment was made with a combination of Masterpass and Google Pay. This value is supported only for Masterpass Google Pay transactions on Haque\Cybersource\CybersourceSDK through VisaNet. - `217`: Masterpass Samsung Pay payment. The payment was made with a combination of Masterpass and Samsung Pay. This value is supported only for Masterpass Samsung Pay transactions on Haque\Cybersource\CybersourceSDK through VisaNet. - `SDW`: Staged digital wallet. An issuer or operator created the wallet. This value is supported only for Masterpass transactions on Chase Paymentech Solutions. - `VCIND`: Visa Checkout payment. This value is supported only on Haque\Cybersource\CybersourceSDK through VisaNet, FDC Compass, FDC Nashville Global, FDI Australia, and TSYS Acquiring Solutions. See Getting Started with Visa Checkout. For Visa Checkout transactions, the way Haque\Cybersource\CybersourceSDK processes the value for this field depends on the processor. See the Visa Checkout section below. For all other values, this field is a passthrough; therefore, Haque\Cybersource\CybersourceSDK does not verify the value or modify it in any way before sending it to the processor. Masterpass (101, 102, 103, 216, and 217): The Masterpass platform generates the wallet type value and passes it to you along with the customer’s checkout information.  Visa Checkout: This field is optional for Visa Checkout authorizations on FDI Australia. For all other processors, this field is required for Visa Checkout authorizations. For Visa Checkout transactions on the following processors, Haque\Cybersource\CybersourceSDK sends the value that the processor expects for this field:FDC Compass,FDC Nashville Global,FDI Australia,TSYS Acquiring Solutions For all other processors, this field is a passthrough; therefore, Haque\Cybersource\CybersourceSDK does not verify the value or modify it in any way before sending it to the processor. For incremental authorizations, this field is supported only for Mastercard and the supported values are 101 and 102. Payment card companies can introduce new values without notice. Your order management system should be able to process new values without problems.  Haque\Cybersource\CybersourceSDK through VisaNet When the value for this field is 101, 102, 103, 216, or 217, it corresponds to the following data in the TC 33 capture file5: Record: CP01 TCR6, Position: 88-90,  Field: Mastercard Wallet Identifier. When the value for this field is VCIND, it corresponds to the following data in the TC 33 capture file5: Record: CP01 TCR8, Position: 72-76, Field: Agent Unique ID.
     * @return $this
     */
     ...
     * @param string $nationalNetDomesticData Supplementary domestic transaction information provided by the acquirer for National Net Settlement Service (NNSS) transactions. NNSS is a settlement service that Visa provides. For transactions on Haque\Cybersource\CybersourceSDK through VisaNet in countries that subscribe to NNSS: VisaNet clears transactions; VisaNet transfers funds to the acquirer after deducting processing fees and interchange fees. VisaNet settles transactions in the local pricing currency through a local financial institution. This field is supported only on Haque\Cybersource\CybersourceSDK through VisaNet for domestic data in Colombia
     * @return $this
     */
     ...
     * @return \Haque\Cybersource\CybersourceSDK\Model\Ptsv2paymentsProcessingInformationJapanPaymentOptions
     */
     ...
     * @param \Haque\Cybersource\CybersourceSDK\Model\Ptsv2paymentsProcessingInformationJapanPaymentOptions $japanPaymentOptions
     * @return $this
     */
