...
/**
 * RiskV1DecisionsPost201ResponseRiskInformationTravelFirstDestination Class Doc Comment
 *
 * @category    Class
 * @package     Haque\Cybersource\CybersourceSDK
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class RiskV1DecisionsPost201ResponseRiskInformationTravelFirstDestination implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'riskV1DecisionsPost201Response_riskInformation_travel_firstDestination';
    ...
    /**
     * Sets country
     * @param string $country Country of first destination on the route.
     * @return $this
     */
    public function setCountry($country)
    {
        if (!is_null($country) && (strlen($country) > 90)) {
            throw new \InvalidArgumentException('invalid length for $country when calling RiskV1DecisionsPost201ResponseRiskInformationTravelFirstDestination., must be smaller than or equal to 90.');
        }
    ...
    /**
     * Sets locality
     * @param string $locality City of first destination on the route.
     * @return $this
     */
    public function setLocality($locality)
    {
        if (!is_null($locality) && (strlen($locality) > 90)) {
            throw new \InvalidArgumentException('invalid length for $locality when calling RiskV1DecisionsPost201ResponseRiskInformationTravelFirstDestination., must be smaller than or equal to 90.');
        }
    ...
    /**
     * Sets latitude
     * @param string $latitude Latitude of first destination on the route.
     * @return $this
     */
    public function setLatitude($latitude)
    {
        if (!is_null($latitude) && (strlen($latitude) > 10)) {
            throw new \InvalidArgumentException('invalid length for $latitude when calling RiskV1DecisionsPost201ResponseRiskInformationTravelFirstDestination., must be smaller than or equal to 10.');
        }
    ...
    /**
     * Sets longitude
     * @param string $longitude Longitude of first destination on the route.
     * @return $this
     */
    public function setLongitude($longitude)
    {
        if (!is_null($longitude) && (strlen($longitude) > 10)) {
            throw new \InvalidArgumentException('invalid length for $longitude when calling RiskV1DecisionsPost201ResponseRiskInformationTravelFirstDestination., must be smaller than or equal to 10.');
        }
