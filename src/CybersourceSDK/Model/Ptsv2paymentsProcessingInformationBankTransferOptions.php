...
class Ptsv2paymentsProcessingInformationBankTransferOptions implements ArrayAccess
{
    ...
    /**
     * Sets effectiveDate
     * @param string $effectiveDate Effective date for the transaction. The effective date must be within 45 days of the current day. If you do not include this value, Haque\Cybersource\CybersourceSDK sets the effective date to the next business day.  Format: `MMDDYYYY`  Supported only for the Haque\Cybersource\CybersourceSDK ACH Service.
     * @return $this
     */
