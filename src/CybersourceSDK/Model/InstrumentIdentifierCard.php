...
/**
 * InstrumentIdentifierCard Class Doc Comment
 *
 * @category    Class
 * @package     Haque\Cybersource\CybersourceSDK
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class InstrumentIdentifierCard implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'InstrumentIdentifierCard';
    ...
    public function setNumber($number)
    {
        if (!is_null($number) && (strlen($number) > 19)) {
            throw new \InvalidArgumentException('invalid length for $number when calling InstrumentIdentifierCard., must be smaller than or equal to 19.');
        }
        if (!is_null($number) && (strlen($number) < 12)) {
            throw new \InvalidArgumentException('invalid length for $number when calling InstrumentIdentifierCard., must be bigger than or equal to 12.');
        }
