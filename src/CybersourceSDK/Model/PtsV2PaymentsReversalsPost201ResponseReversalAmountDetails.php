...
class PtsV2PaymentsReversalsPost201ResponseReversalAmountDetails implements ArrayAccess
{
    ...
    /**
     * Sets reversedAmount
     * @param string $reversedAmount Total reversed amount.  For details, see `auth_reversal_amount` field description in [Credit Card Services Using the SCMP API.](https://apps.cybersource.com/library/documentation/dev_guides/CC_Svcs_SCMP_API/html/)
     * @return $this
     */
     ...
     * @param string $originalTransactionAmount Amount of the original transaction.  For details, see `original_transaction_amount` field description in [Credit Card Services Using the SCMP API.](https://apps.cybersource.com/library/documentation/dev_guides/CC_Svcs_SCMP_API/html/)
     * @return $this
     */
