...
/**
 * InlineResponseDefaultResponseStatusDetails Class Doc Comment
 *
 * @category    Class
 * @package     Haque\Cybersource\CybersourceSDK
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class InlineResponseDefaultResponseStatusDetails implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_default_responseStatus_details';
    ...
    /**
     * Sets location
     * @param string $location Field name referred to for validation issues.
     * @return $this
     */
    ...
    /**
     * Sets message
     * @param string $message Description or code of any error response.
     * @return $this
     */
