...
class Ptsv2paymentsOrderInformationBillTo implements ArrayAccess
{
    ...
    /**
     * Sets buildingNumber
     * @param string $buildingNumber Building number in the street address.  For example, if the street address is: Rua da Quitanda 187 then the building number is 187.  This field is supported only for:  - Cielo transactions.  - Redecard customer validation with Haque\Cybersource\CybersourceSDK Latin American Processing.
     * @return $this
     */
