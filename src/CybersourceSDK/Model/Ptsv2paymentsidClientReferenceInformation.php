...
/**
 * Ptsv2paymentsidClientReferenceInformation Class Doc Comment
 *
 * @category    Class
 * @package     Haque\Cybersource\CybersourceSDK
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Ptsv2paymentsidClientReferenceInformation implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ptsv2paymentsid_clientReferenceInformation';
    ...
    protected static $swaggerTypes = [
        'code' => 'string',
        'partner' => '\Haque\Cybersource\CybersourceSDK\Model\Ptsv2paymentsidClientReferenceInformationPartner'
    ];
    ...
    public function setCode($code)
    {
        if (!is_null($code) && (strlen($code) > 50)) {
            throw new \InvalidArgumentException('invalid length for $code when calling Ptsv2paymentsidClientReferenceInformation., must be smaller than or equal to 50.');
        }
    ...
    /**
     * Gets partner
     * @return \Haque\Cybersource\CybersourceSDK\Model\Ptsv2paymentsidClientReferenceInformationPartner
     */
    ...
    /**
     * Sets partner
     * @param \Haque\Cybersource\CybersourceSDK\Model\Ptsv2paymentsidClientReferenceInformationPartner $partner
     * @return $this
     */
