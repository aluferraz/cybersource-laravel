...
/**
 * Riskv1decisionsRiskInformationProfile Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Riskv1decisionsRiskInformationProfile implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'riskv1decisions_riskInformation_profile';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (strlen($name) > 30)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Riskv1decisionsRiskInformationProfile., must be smaller than or equal to 30.');
        }
