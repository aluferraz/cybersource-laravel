...
class UserManagementApi
{
     ...
     * @return array of \Haque\Cybersource\CybersourceSDK\Model\UmsV1UsersGet200Response, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function getUsersWithHttpInfo($organizationId = null, $userName = null, $permissionId = null, $roleId = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Haque\Cybersource\CybersourceSDK\Model\UmsV1UsersGet200Response',
                '/ums/v1/users'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Haque\Cybersource\CybersourceSDK\Model\UmsV1UsersGet200Response', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Haque\Cybersource\CybersourceSDK\Model\UmsV1UsersGet200Response', $e->getResponseHeaders());
