...
class NotificationOfChangesApi
{
     ...
     * @return array of \Haque\Cybersource\CybersourceSDK\Model\ReportingV3NotificationofChangesGet200Response, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function getNotificationOfChangeReportWithHttpInfo($startTime, $endTime)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Haque\Cybersource\CybersourceSDK\Model\ReportingV3NotificationofChangesGet200Response',
                '/reporting/v3/notification-of-changes'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Haque\Cybersource\CybersourceSDK\Model\ReportingV3NotificationofChangesGet200Response', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Haque\Cybersource\CybersourceSDK\Model\ReportingV3NotificationofChangesGet200Response', $e->getResponseHeaders());
