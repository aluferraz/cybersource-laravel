...
class VoidApi
{
     ...
     *
     * @param \Haque\Cybersource\CybersourceSDK\Model\MitVoidRequest $mitVoidRequest  (required)
     * @throws \Haque\Cybersource\CybersourceSDK\ApiException on non-2xx response
     * @return array of \Haque\Cybersource\CybersourceSDK\Model\PtsV2PaymentsVoidsPost201Response, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function mitVoidWithHttpInfo($mitVoidRequest)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Haque\Cybersource\CybersourceSDK\Model\PtsV2PaymentsVoidsPost201Response',
                '/pts/v2/voids/'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Haque\Cybersource\CybersourceSDK\Model\PtsV2PaymentsVoidsPost201Response', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 201:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Haque\Cybersource\CybersourceSDK\Model\PtsV2PaymentsVoidsPost201Response', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Haque\Cybersource\CybersourceSDK\Model\PtsV2PaymentsVoidsPost400Response', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 502:
     ...
     * Void a Capture
     *
     * @param \Haque\Cybersource\CybersourceSDK\Model\VoidCaptureRequest $voidCaptureRequest  (required)
     ...
     * Void a Credit
     *
     * @param \Haque\Cybersource\CybersourceSDK\Model\VoidCreditRequest $voidCreditRequest  (required)
     ...
     * Void a Payment
     *
     * @param \Haque\Cybersource\CybersourceSDK\Model\VoidPaymentRequest $voidPaymentRequest  (required)
     ...
     * Void a Refund
     *
     * @param \Haque\Cybersource\CybersourceSDK\Model\VoidRefundRequest $voidRefundRequest  (required)
