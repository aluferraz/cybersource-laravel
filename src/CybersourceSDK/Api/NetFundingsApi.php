...
class NetFundingsApi
{
     ...
     * @param string $groupName Valid Haque\Cybersource\CybersourceSDK Group Name. (optional)
     * @throws \Haque\Cybersource\CybersourceSDK\ApiException on non-2xx response
     * @return array of \Haque\Cybersource\CybersourceSDK\Model\ReportingV3NetFundingsGet200Response, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function getNetFundingDetailsWithHttpInfo($startTime, $endTime, $organizationId = null, $groupName = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Haque\Cybersource\CybersourceSDK\Model\ReportingV3NetFundingsGet200Response',
                '/reporting/v3/net-fundings'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Haque\Cybersource\CybersourceSDK\Model\ReportingV3NetFundingsGet200Response', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Haque\Cybersource\CybersourceSDK\Model\ReportingV3NetFundingsGet200Response', $e->getResponseHeaders());
