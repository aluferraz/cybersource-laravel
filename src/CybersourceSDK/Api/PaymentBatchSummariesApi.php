...
class PaymentBatchSummariesApi
{
     ...
     * @return array of \Haque\Cybersource\CybersourceSDK\Model\ReportingV3PaymentBatchSummariesGet200Response, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function getPaymentBatchSummaryWithHttpInfo($startTime, $endTime, $organizationId = null, $rollUp = null, $breakdown = null, $startDayOfWeek = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Haque\Cybersource\CybersourceSDK\Model\ReportingV3PaymentBatchSummariesGet200Response',
                '/reporting/v3/payment-batch-summaries'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Haque\Cybersource\CybersourceSDK\Model\ReportingV3PaymentBatchSummariesGet200Response', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Haque\Cybersource\CybersourceSDK\Model\ReportingV3PaymentBatchSummariesGet200Response', $e->getResponseHeaders());
