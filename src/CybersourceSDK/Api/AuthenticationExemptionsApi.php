...
class AuthenticationExemptionsApi
{
     ...
     *
     * @param \Haque\Cybersource\CybersourceSDK\Model\AuthenticationExemptionsRequest $authenticationExemptionsRequest  (required)
     * @throws \Haque\Cybersource\CybersourceSDK\ApiException on non-2xx response
     * @return array of \Haque\Cybersource\CybersourceSDK\Model\RiskV1AuthenticationExemptionsPost201Response, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function authenticationExemptionsWithHttpInfo($authenticationExemptionsRequest)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Haque\Cybersource\CybersourceSDK\Model\RiskV1AuthenticationExemptionsPost201Response',
                '/risk/v1/authentication-exemptions'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Haque\Cybersource\CybersourceSDK\Model\RiskV1AuthenticationExemptionsPost201Response', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 201:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Haque\Cybersource\CybersourceSDK\Model\RiskV1AuthenticationExemptionsPost201Response', $e->getResponseHeaders());
