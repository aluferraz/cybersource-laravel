...
class RefundApi
{
     ...
     * Refund a Capture
     *
     * @param \Haque\Cybersource\CybersourceSDK\Model\RefundCaptureRequest $refundCaptureRequest  (required)
     ...
     * @return array of \Haque\Cybersource\CybersourceSDK\Model\PtsV2PaymentsRefundPost201Response, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function refundCaptureWithHttpInfo($refundCaptureRequest, $id)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Haque\Cybersource\CybersourceSDK\Model\PtsV2PaymentsRefundPost201Response',
                '/pts/v2/captures/{id}/refunds'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Haque\Cybersource\CybersourceSDK\Model\PtsV2PaymentsRefundPost201Response', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 201:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Haque\Cybersource\CybersourceSDK\Model\PtsV2PaymentsRefundPost201Response', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Haque\Cybersource\CybersourceSDK\Model\PtsV2PaymentsRefundPost400Response', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 502:
     ...
     * Refund a Payment
     *
     * @param \Haque\Cybersource\CybersourceSDK\Model\RefundPaymentRequest $refundPaymentRequest  (required)
