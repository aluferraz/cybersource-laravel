...
class ConversionDetailsApi
{
     ...
     * @return array of \Haque\Cybersource\CybersourceSDK\Model\ReportingV3ConversionDetailsGet200Response, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function getConversionDetailWithHttpInfo($startTime, $endTime, $organizationId = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Haque\Cybersource\CybersourceSDK\Model\ReportingV3ConversionDetailsGet200Response',
                '/reporting/v3/conversion-details'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Haque\Cybersource\CybersourceSDK\Model\ReportingV3ConversionDetailsGet200Response', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Haque\Cybersource\CybersourceSDK\Model\ReportingV3ConversionDetailsGet200Response', $e->getResponseHeaders());
